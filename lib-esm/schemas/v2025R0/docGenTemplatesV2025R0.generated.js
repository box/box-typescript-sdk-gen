...
export function serializeDocGenTemplatesV2025R0(val) {
    return {
        ['limit']: val.limit,
...
export function deserializeDocGenTemplatesV2025R0(val) {
    if (!sdIsMap(val)) {
...
//# sourceMappingURL=docGenTemplatesV2025R0.generated.js.map