...
export function serializeDocGenJobV2025R0StatusField(val) {
    return val;
}
export function deserializeDocGenJobV2025R0StatusField(val) {
    if (val == 'submitted') {
        return val;
    }
    if (val == 'completed') {
...
export function serializeDocGenJobV2025R0(val) {
    const base = serializeDocGenJobBaseV2025R0(val);
    if (!sdIsMap(base)) {
        throw new BoxSdkError({
    ...
    return {
        ...
        ...{
            ...
            ['template_file_version']: serializeFileVersionBaseV2025R0(val.templateFileVersion),
...
export function deserializeDocGenJobV2025R0(val) {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({
            message: 'Expecting a map for "DocGenJobV2025R0"',
        });
