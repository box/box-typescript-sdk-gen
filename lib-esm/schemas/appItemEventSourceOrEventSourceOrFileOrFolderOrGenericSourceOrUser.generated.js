...
export function serializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(val) {
...
export function deserializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(val) {
    if (!sdIsMap(val)) {
