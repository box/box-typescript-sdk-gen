...
export function serializeAiStudioAgentExtractTypeField(val) {
    return val;
}
export function deserializeAiStudioAgentExtractTypeField(val) {
...
export function serializeAiStudioAgentExtract(val) {
    return {
...
export function deserializeAiStudioAgentExtract(val) {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({
...
export function serializeAiStudioAgentExtractInput(val) {
    return {
...
export function deserializeAiStudioAgentExtractInput(val) {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({
