...
export function serializeRetentionPolicyPolicyTypeField(val) {
    return val;
}
export function deserializeRetentionPolicyPolicyTypeField(val) {
    if (val == 'finite') {
        return val;
    }
    if (val == 'indefinite') {
...
export function serializeRetentionPolicyRetentionTypeField(val) {
    return val;
}
export function deserializeRetentionPolicyRetentionTypeField(val) {
    if (val == 'modifiable') {
        return val;
    }
...
export function serializeRetentionPolicyStatusField(val) {
    return val;
}
export function deserializeRetentionPolicyStatusField(val) {
    if (val == 'active') {
        return val;
    }
    if (val == 'retired') {
...
export function serializeRetentionPolicyAssignmentCountsField(val) {
    return {
...
export function deserializeRetentionPolicyAssignmentCountsField(val) {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({
...
export function serializeRetentionPolicy(val) {
...
export function deserializeRetentionPolicy(val) {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: 'Expecting a map for "RetentionPolicy"' });
    }
