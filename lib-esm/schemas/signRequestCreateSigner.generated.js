...
export function serializeSignRequestCreateSignerRoleField(val) {
    return val;
}
export function deserializeSignRequestCreateSignerRoleField(val) {
    if (val == 'signer') {
        return val;
    }
    if (val == 'approver') {
...
export function serializeSignRequestCreateSigner(val) {
    return {
        ['email']: val.email,
...
export function deserializeSignRequestCreateSigner(val) {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({
