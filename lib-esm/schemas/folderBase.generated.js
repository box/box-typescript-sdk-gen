...
export function serializeFolderBaseTypeField(val) {
    return val;
}
export function deserializeFolderBaseTypeField(val) {
    if (val == 'folder') {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize FolderBaseTypeField" });
}
export function serializeFolderBase(val) {
    return {
        ['id']: val.id,
        ['etag']: val.etag,
...
export function deserializeFolderBase(val) {
    if (!sdIsMap(val)) {
...
export function serializeFolderBaseInput(val) {
    return {
        ['id']: val.id,
        ['etag']: val.etag,
...
export function deserializeFolderBaseInput(val) {
    if (!sdIsMap(val)) {
