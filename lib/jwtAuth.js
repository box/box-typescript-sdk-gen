    ...
    refreshToken(networkSession) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (responseJson.error && responseJson.error === 'invalid_grant') {
                ...
                const decoded = jsonwebtoken_1.default.decode(assertion, { complete: true });
                message = `${message} [SystemTime: ${Date.now()}] [DateHeader: ${header}] [DecodedJWT: ${JSON.stringify(decoded)}] [Claims: ${JSON.stringify(claims)}]`;
