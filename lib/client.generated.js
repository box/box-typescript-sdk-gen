...
const hubs_generated_js_1 = require("./managers/hubs.generated.js");
const hubCollaborations_generated_js_1 = require("./managers/hubCollaborations.generated.js");
const hubItems_generated_js_1 = require("./managers/hubItems.generated.js");
const shieldLists_generated_js_1 = require("./managers/shieldLists.generated.js");
const archives_generated_js_1 = require("./managers/archives.generated.js");
...
class BoxClient {
    constructor(fields) {
        ...
        this.hubs = new hubs_generated_js_1.HubsManager({
            auth: this.auth,
            networkSession: this.networkSession,
        });
        this.hubCollaborations = new hubCollaborations_generated_js_1.HubCollaborationsManager({
            auth: this.auth,
            networkSession: this.networkSession,
        });
        this.hubItems = new hubItems_generated_js_1.HubItemsManager({
            auth: this.auth,
            networkSession: this.networkSession,
        });
        this.shieldLists = new shieldLists_generated_js_1.ShieldListsManager({
            auth: this.auth,
            networkSession: this.networkSession,
        });
        this.archives = new archives_generated_js_1.ArchivesManager({
            auth: this.auth,
            networkSession: this.networkSession,
        });
    }
