...
test("testCreateGetAndDeleteFile", function testCreateGetAndDeleteFile() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        expect(() => __awaiter(this, void 0, void 0, function* () { yield client.files.getFileById(uploadedFile.id, { fields: "name" }, new files_generated_js_1.GetFileByIdHeadersArg({ extraHeaders: { ["if-none-match"]: file.etag } })); })).rejects.toThrow();
