...
test('testUpdatingFolderMetadata', function testUpdatingFolderMetadata() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createdMetadata = yield exports.client.folderMetadata.createFolderMetadataById(folder.id, 'enterprise', templateKey, {
            ['name']: 'John',
            ['age']: 23,
        ...
        const updatedMetadata = yield exports.client.folderMetadata.updateFolderMetadataById(folder.id, 'enterprise', templateKey, [
            {
                op: 'replace',
                path: '/name',
                value: 'Jack',
        ...
        yield exports.client.folderMetadata.deleteFolderMetadataById(folder.id, 'enterprise', templateKey);
...
test('testGlobalFolderMetadata', function testGlobalFolderMetadata() {
    return __awaiter(this, void 0, void 0, function* () {
        const folder = yield (0, commons_generated_js_2.createNewFolder)();
        const folderMetadata = yield exports.client.folderMetadata.getFolderMetadata(folder.id);
        if (!(folderMetadata.entries.length == 0)) {
            throw new Error('Assertion failed');
        }
        const createdMetadata = yield exports.client.folderMetadata.createFolderMetadataById(folder.id, 'global', 'properties', { ['abc']: 'xyz' });
        ...
        const receivedMetadata = yield exports.client.folderMetadata.getFolderMetadataById(folder.id, 'global', 'properties');
        if (!((0, utils_js_2.toString)(receivedMetadata.extraData.abc) == 'xyz')) {
            throw new Error('Assertion failed');
        }
        const newValue = 'bar';
        yield exports.client.folderMetadata.updateFolderMetadataById(folder.id, 'global', 'properties', [
            {
                op: 'replace',
                path: '/abc',
                value: newValue,
        ...
        const receivedUpdatedMetadata = yield exports.client.folderMetadata.getFolderMetadataById(folder.id, 'global', 'properties');
        if (!((0, utils_js_2.toString)(receivedUpdatedMetadata.extraData.abc) == newValue)) {
            throw new Error('Assertion failed');
        }
        yield exports.client.folderMetadata.deleteFolderMetadataById(folder.id, 'global', 'properties');
        yield expect(() => __awaiter(this, void 0, void 0, function* () {
            yield exports.client.folderMetadata.getFolderMetadataById(folder.id, 'global', 'properties');
        })).rejects.toThrow();
        yield exports.client.folders.deleteFolderById(folder.id);
    });
});
