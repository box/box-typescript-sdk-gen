...
test("test_download_file", function test_download_file() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileBuffer = (0, utils_js_4.generateByteBuffer)(1048576);
        ...
        if (!(0, utils_js_6.bufferEquals)(yield (0, utils_js_7.readByteStream)(downloadedFileContent), fileBuffer)) {
