...
test('testFileClassifications', function testFileClassifications() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () {
            yield exports.client.fileClassifications.getClassificationOnFile(file.id);
        })).rejects.toThrow();
        const createdFileClassification = yield exports.client.fileClassifications.addClassificationToFile(file.id, {
            requestBody: {
        ...
        const fileClassification = yield exports.client.fileClassifications.getClassificationOnFile(file.id);
        ...
        const updatedFileClassification = yield exports.client.fileClassifications.updateClassificationOnFile(file.id, [
            new fileClassifications_generated_js_1.UpdateClassificationOnFileRequestBody({
        ...
        yield exports.client.fileClassifications.deleteClassificationFromFile(file.id);
        yield expect(() => __awaiter(this, void 0, void 0, function* () {
            yield exports.client.fileClassifications.getClassificationOnFile(file.id);
        })).rejects.toThrow();
