    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function reducer(acc, chunk) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const uploadedPart = yield client.chunkedUploads.uploadFilePart(uploadSessionId, uploadedChunk, { digest: digest, contentRange: contentRange });
        ...
        const digest = "".concat("sha=", sha1);
        const commmitedSession = yield client.chunkedUploads.createFileUploadSessionCommit(uploadSessionId, { parts: parts }, { digest: digest });
