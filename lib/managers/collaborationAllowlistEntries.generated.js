...
class CollaborationAllowlistEntriesManager {
    ...
    getCollaborationWhitelistEntries(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaboration_whitelist_entries"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetCollaborationWhitelistEntriesQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
