...
class CollaborationAllowlistEntriesManager {
    ...
    getCollaborationWhitelistEntries(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaborationAllowlistEntries)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postCollaborationWhitelistEntries(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeCollaborationAllowlistEntry)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
