...
class FoldersManager {
    ...
    getFolderById(folderId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId), { method: "GET", params: (0, utils_js_1.prepareParams)(queryParams), headers: (0, utils_js_1.prepareParams)(headers), auth: this.auth, networkSession: this.networkSession });
    ...
    updateFolderById(folderId, requestBody, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId), { method: "PUT", params: (0, utils_js_1.prepareParams)(queryParams), headers: (0, utils_js_1.prepareParams)(headers), body: JSON.stringify(requestBody), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFolderFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    deleteFolderById(folderId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId), { method: "DELETE", params: (0, utils_js_1.prepareParams)(queryParams), headers: (0, utils_js_1.prepareParams)(headers), auth: this.auth, networkSession: this.networkSession });
            return response.content;
        });
    }
    getFolderItems(folderId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId, "/items"), { method: "GET", params: (0, utils_js_1.prepareParams)(queryParams), headers: (0, utils_js_1.prepareParams)(headers), auth: this.auth, networkSession: this.networkSession });
    ...
    createFolder(requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders"), { method: "POST", params: (0, utils_js_1.prepareParams)(queryParams), body: JSON.stringify(requestBody), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFolderFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    copyFolder(folderId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId, "/copy"), { method: "POST", params: (0, utils_js_1.prepareParams)(queryParams), body: JSON.stringify(requestBody), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFolderFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
