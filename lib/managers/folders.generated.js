...
class FoldersManager {
    ...
    getFolderById(folderId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headersMap = (0, utils_js_1.prepareParams)({ ["if-none-match"]: (0, utils_js_2.toString)(headers.ifNoneMatch), ["boxapi"]: (0, utils_js_2.toString)(headers.boxapi) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId), { method: "GET", params: queryParamsMap, headers: headersMap, auth: this.auth, networkSession: this.networkSession });
    ...
    updateFolderById(folderId, requestBody, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headersMap = (0, utils_js_1.prepareParams)({ ["if-match"]: (0, utils_js_2.toString)(headers.ifMatch) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId), { method: "PUT", params: queryParamsMap, headers: headersMap, body: (0, json_js_2.serializeJson)(serializeUpdateFolderByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFolderFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    deleteFolderById(folderId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headersMap = (0, utils_js_1.prepareParams)({ ["if-match"]: (0, utils_js_2.toString)(headers.ifMatch) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId), { method: "DELETE", params: queryParamsMap, headers: headersMap, auth: this.auth, networkSession: this.networkSession });
    ...
    getFolderItems(folderId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headersMap = (0, utils_js_1.prepareParams)({ ["boxapi"]: (0, utils_js_2.toString)(headers.boxapi) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId, "/items"), { method: "GET", params: queryParamsMap, headers: headersMap, auth: this.auth, networkSession: this.networkSession });
    ...
    createFolder(requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["fields"]: (0, utils_js_2.toString)(queryParams.fields) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders"), { method: "POST", params: queryParamsMap, body: (0, json_js_2.serializeJson)(serializeCreateFolderRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFolderFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    copyFolder(folderId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["fields"]: (0, utils_js_2.toString)(queryParams.fields) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId, "/copy"), { method: "POST", params: queryParamsMap, body: (0, json_js_2.serializeJson)(serializeCopyFolderRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFolderFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
exports.FoldersManager = FoldersManager;
function serializeGetFolderByIdQueryParamsArgSortField(val) {
    return val;
}
exports.serializeGetFolderByIdQueryParamsArgSortField = serializeGetFolderByIdQueryParamsArgSortField;
function deserializeGetFolderByIdQueryParamsArgSortField(val) {
...
exports.deserializeGetFolderByIdQueryParamsArgSortField = deserializeGetFolderByIdQueryParamsArgSortField;
function serializeGetFolderByIdQueryParamsArgDirectionField(val) {
    return val;
}
exports.serializeGetFolderByIdQueryParamsArgDirectionField = serializeGetFolderByIdQueryParamsArgDirectionField;
function deserializeGetFolderByIdQueryParamsArgDirectionField(val) {
    if (!(0, json_js_3.isJson)(val, "string")) {
...
exports.deserializeGetFolderByIdQueryParamsArgDirectionField = deserializeGetFolderByIdQueryParamsArgDirectionField;
...
function deserializeGetFolderByIdQueryParamsArg(val) {
    ...
    const sort = val.sort == void 0 ? void 0 : deserializeGetFolderByIdQueryParamsArgSortField(val.sort);
    const direction = val.direction == void 0 ? void 0 : deserializeGetFolderByIdQueryParamsArgDirectionField(val.direction);
    ...
    return { fields: fields, sort: sort, direction: direction, offset: offset, limit: limit };
}
...
function deserializeGetFolderByIdHeadersArg(val) {
    ...
    const boxapi = (0, json_js_3.isJson)(val.boxapi, "string") ? val.boxapi : void 0;
...
function deserializeDeleteFolderByIdQueryParamsArg(val) {
    const recursive = (0, json_js_3.isJson)(val.recursive, "boolean") ? val.recursive : void 0;
