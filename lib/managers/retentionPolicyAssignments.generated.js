...
class RetentionPolicyAssignmentsManager {
    ...
    getRetentionPoliciesIdAssignments(retentionPolicyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeRetentionPolicyAssignments)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postRetentionPolicyAssignments(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeRetentionPolicyAssignment)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    getRetentionPolicyAssignmentsIdFilesUnderRetention(retentionPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeFilesUnderRetention)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
