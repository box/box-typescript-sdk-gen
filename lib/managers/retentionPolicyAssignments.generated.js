...
class RetentionPolicyAssignmentsManager {
    ...
    getRetentionPolicyAssignments(retentionPolicyId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policies/", retentionPolicyId, "/assignments"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
    ...
    createRetentionPolicyAssignment(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policy_assignments"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateRetentionPolicyAssignmentRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    getRetentionPolicyAssignmentById(retentionPolicyAssignmentId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policy_assignments/", retentionPolicyAssignmentId), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeRetentionPolicyAssignment)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    getRetentionPolicyAssignmentFileUnderRetention(retentionPolicyAssignmentId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policy_assignments/", retentionPolicyAssignmentId, "/files_under_retention"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
    ...
    getRetentionPolicyAssignmentFileVersionUnderRetention(retentionPolicyAssignmentId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["marker"]: (0, utils_js_2.toString)(queryParams.marker), ["limit"]: (0, utils_js_2.toString)(queryParams.limit) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policy_assignments/", retentionPolicyAssignmentId, "/file_versions_under_retention"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_3.deserializeFilesUnderRetention)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
