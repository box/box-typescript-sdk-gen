...
class RetentionPolicyAssignmentsManager {
    ...
    getRetentionPoliciesIdAssignments(retentionPolicyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeRetentionPolicyAssignments)(deserializeJSON(response.text));
        });
    }
    postRetentionPolicyAssignments(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeRetentionPolicyAssignment)(deserializeJSON(response.text));
        });
    }
    ...
    getRetentionPolicyAssignmentsIdFilesUnderRetention(retentionPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeFilesUnderRetention)(deserializeJSON(response.text));
        });
    }
