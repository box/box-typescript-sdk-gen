...
class RetentionPolicyAssignmentsManager {
    ...
    getRetentionPoliciesIdAssignments(retentionPolicyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeRetentionPolicyAssignments)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    postRetentionPolicyAssignments(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policy_assignments"), { method: "POST", body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeRetentionPolicyAssignment)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    getRetentionPolicyAssignmentsId(retentionPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteRetentionPolicyAssignmentsId(retentionPolicyAssignmentId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getRetentionPolicyAssignmentsIdFilesUnderRetention(retentionPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeFilesUnderRetention)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    getRetentionPolicyAssignmentsIdFileVersionsUnderRetention(retentionPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=retention_policy_assignments.generated.js.map