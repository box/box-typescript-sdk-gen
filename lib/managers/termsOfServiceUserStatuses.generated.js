...
class TermsOfServiceUserStatusesManager {
    ...
    getTermsOfServiceUserStatuses(tosId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeTermsOfServiceUserStatuses)(deserializeJSON(response.text));
        });
    }
    postTermsOfServiceUserStatuses(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeTermsOfServiceUserStatus)(deserializeJSON(response.text));
        });
    }
