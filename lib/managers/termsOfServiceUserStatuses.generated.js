...
class TermsOfServiceUserStatusesManager {
    ...
    getTermOfServiceUserStatuses(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_service_user_statuses"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetTermOfServiceUserStatusesQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    createTermOfServiceUserStatus(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_service_user_statuses"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateTermOfServiceUserStatusRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    updateTermOfServiceUserStatusById(termsOfServiceUserStatusId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_service_user_statuses/", termsOfServiceUserStatusId), { method: "PUT", body: (0, json_js_2.serializeJson)(serializeUpdateTermOfServiceUserStatusByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeTermsOfServiceUserStatus)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
...
function deserializeGetTermOfServiceUserStatusesQueryParamsArg(val) {
    const tosId = val.tos_id;
    const userId = (0, json_js_3.isJson)(val.user_id, "string") ? val.user_id : void 0;
