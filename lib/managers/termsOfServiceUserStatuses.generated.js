...
class TermsOfServiceUserStatusesManager {
    ...
    getTermOfServiceUserStatuses(tosId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_service_user_statuses"), { method: "GET", params: { ["tos_id"]: tosId, ["user_id"]: options.userId }, auth: this.auth, networkSession: this.networkSession });
