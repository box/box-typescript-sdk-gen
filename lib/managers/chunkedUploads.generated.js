...
class ChunkedUploadsManager {
    ...
    postFilesUploadSessions(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeUploadSession)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    getFilesUploadSessionsIdParts(uploadSessionId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeUploadParts)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postFilesUploadSessionsIdCommit(uploadSessionId, digest, requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeFiles)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
}
