...
class ChunkedUploadsManager {
    ...
    postFilesUploadSessions(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeUploadSession)(deserializeJSON(response.text));
        });
    }
    ...
    getFilesUploadSessionsIdParts(uploadSessionId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeUploadParts)(deserializeJSON(response.text));
        });
    }
    postFilesUploadSessionsIdCommit(uploadSessionId, digest, requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeFiles)(deserializeJSON(response.text));
        });
    }
}
