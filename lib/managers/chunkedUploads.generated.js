...
class ChunkedUploadsManager {
    ...
    uploadFilePart(uploadSessionId, requestBody, headers) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://upload.box.com/api/2.0/files/upload_sessions/", uploadSessionId), { method: "PUT", headers: (0, utils_js_1.prepareParams)(serializeUploadFilePartHeadersArg(headers)), body: requestBody, contentType: "application/octet-stream", auth: this.auth, networkSession: this.networkSession });
    ...
    getFileUploadSessionParts(uploadSessionId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://upload.box.com/api/2.0/files/upload_sessions/", uploadSessionId, "/parts"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetFileUploadSessionPartsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
