...
class SignRequestsManager {
    ...
    postSignRequestsIdCancel(signRequestId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeSignRequest)(deserializeJSON(response.text));
        });
    }
    ...
    getSignRequests(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeSignRequests)(deserializeJSON(response.text));
        });
    }
    postSignRequests(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/sign_requests"), { method: "POST", body: (0, schemas_generated_js_3.serializeSignRequestCreateRequest)(serializeJSON(requestBody)), auth: this.auth });
            return (0, schemas_generated_js_1.deserializeSignRequest)(deserializeJSON(response.text));
        });
    }
}
