...
exports.newDeserializeGetSignRequestsQueryParamsArg = exports.newSerializeGetSignRequestsQueryParamsArg = exports.SignRequestsManager = void 0;
...
class SignRequestsManager {
    ...
    cancelSignRequest(signRequestId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.newDeserializeSignRequest)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    getSignRequests(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.newDeserializeSignRequests)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    createSignRequest(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/sign_requests"), { method: "POST", body: (0, json_js_2.serializeJson)((0, schemas_generated_js_3.newSerializeSignRequestCreateRequest)(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.newDeserializeSignRequest)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
exports.SignRequestsManager = SignRequestsManager;
function newSerializeGetSignRequestsQueryParamsArg(val) {
    return { ["marker"]: val.marker, ["limit"]: val.limit };
}
exports.newSerializeGetSignRequestsQueryParamsArg = newSerializeGetSignRequestsQueryParamsArg;
function newDeserializeGetSignRequestsQueryParamsArg(val) {
...
exports.newDeserializeGetSignRequestsQueryParamsArg = newDeserializeGetSignRequestsQueryParamsArg;
