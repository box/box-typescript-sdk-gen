...
class FileRequestsManager {
    ...
    updateFileRequestById(fileRequestId, requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/file_requests/", fileRequestId), { method: "PUT", headers: { ["if-match"]: options.ifMatch }, body: (0, json_js_2.serializeJson)((0, schemas_generated_js_2.serializeFileRequestUpdateRequest)(requestBody)), contentType: "application/json", auth: this.auth });
            return (0, schemas_generated_js_1.deserializeFileRequest)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    createFileRequestCopy(fileRequestId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/file_requests/", fileRequestId, "/copy"), { method: "POST", body: (0, json_js_2.serializeJson)((0, schemas_generated_js_3.serializeFileRequestCopyRequest)(requestBody)), contentType: "application/json", auth: this.auth });
            return (0, schemas_generated_js_1.deserializeFileRequest)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
