...
class FileRequestsManager {
    ...
    updateFileRequestById(fileRequestId, requestBody, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/file_requests/", fileRequestId), { method: "PUT", headers: (0, utils_js_1.toMap)(headers), body: (0, json_js_2.serializeJson)((0, schemas_generated_js_2.serializeFileRequestUpdateRequest)(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFileRequest)((0, json_js_1.deserializeJson)(response.text));
        });
    }
