...
exports.deserializeUpdateFileRequestByIdHeadersArg = exports.serializeUpdateFileRequestByIdHeadersArg = exports.FileRequestsManager = void 0;
...
class FileRequestsManager {
    ...
    updateFileRequestById(fileRequestId, requestBody, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/file_requests/", fileRequestId), { method: "PUT", headers: headersMap, body: (0, json_js_2.serializeJson)((0, schemas_generated_js_2.serializeFileRequestUpdateRequest)(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFileRequest)((0, json_js_1.deserializeJson)(response.text));
        });
    }
...
function serializeUpdateFileRequestByIdHeadersArg(val) {
    return { ["if-match"]: val.ifMatch };
}
exports.serializeUpdateFileRequestByIdHeadersArg = serializeUpdateFileRequestByIdHeadersArg;
function deserializeUpdateFileRequestByIdHeadersArg(val) {
    const ifMatch = (0, json_js_3.isJson)(val["if-match"], "string") ? val["if-match"] : void 0;
    return { ifMatch: ifMatch };
}
exports.deserializeUpdateFileRequestByIdHeadersArg = deserializeUpdateFileRequestByIdHeadersArg;
