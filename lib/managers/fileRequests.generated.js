...
class FileRequestsManager {
    ...
    getFileRequestsId(fileRequestId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeFileRequest)(deserializeJSON(response.text));
        });
    }
    putFileRequestsId(fileRequestId, requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/file_requests/", fileRequestId), { method: "PUT", headers: { ["if-match"]: options.ifMatch }, body: yield (0, schemas_generated_js_2.serializeFileRequestUpdateRequest)(serializeJSON(requestBody)), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeFileRequest)(deserializeJSON(response.text));
        });
    }
    ...
    postFileRequestsIdCopy(fileRequestId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/file_requests/", fileRequestId, "/copy"), { method: "POST", body: yield (0, schemas_generated_js_3.serializeFileRequestCopyRequest)(serializeJSON(requestBody)), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeFileRequest)(deserializeJSON(response.text));
        });
    }
}
