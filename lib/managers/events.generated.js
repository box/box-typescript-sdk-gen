...
class EventsManager {
    ...
    getEvents(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeEvents)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    optionsEvents() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/events"), { method: "OPTIONS", auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeRealtimeServers)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
}
