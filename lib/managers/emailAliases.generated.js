...
exports.newDeserializeCreateUserEmailAliasRequestBodyArg = exports.newSerializeCreateUserEmailAliasRequestBodyArg = exports.EmailAliasesManager = void 0;
...
class EmailAliasesManager {
    ...
    getUserEmailAliases(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.newDeserializeEmailAliases)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    createUserEmailAlias(userId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.newDeserializeEmailAlias)((0, json_js_1.deserializeJson)(response.text));
        });
    }
...
function newSerializeCreateUserEmailAliasRequestBodyArg(val) {
    return { ["email"]: val.email };
}
exports.newSerializeCreateUserEmailAliasRequestBodyArg = newSerializeCreateUserEmailAliasRequestBodyArg;
function newDeserializeCreateUserEmailAliasRequestBodyArg(val) {
    const email = val.email;
    return { email: email };
}
exports.newDeserializeCreateUserEmailAliasRequestBodyArg = newDeserializeCreateUserEmailAliasRequestBodyArg;
