...
class EmailAliasesManager {
    ...
    getUsersIdEmailAliases(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeEmailAliases)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postUsersIdEmailAliases(userId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeEmailAlias)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
