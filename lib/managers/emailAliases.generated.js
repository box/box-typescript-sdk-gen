...
exports.deserializeCreateUserEmailAliasRequestBodyArg = exports.serializeCreateUserEmailAliasRequestBodyArg = exports.EmailAliasesManager = void 0;
...
class EmailAliasesManager {
    ...
    createUserEmailAlias(userId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/users/", userId, "/email_aliases"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateUserEmailAliasRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
