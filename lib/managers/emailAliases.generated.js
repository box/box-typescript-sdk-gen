...
class EmailAliasesManager {
    ...
    getUsersIdEmailAliases(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeEmailAliases)(deserializeJSON(response.text));
        });
    }
    postUsersIdEmailAliases(userId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeEmailAlias)(deserializeJSON(response.text));
        });
    }
