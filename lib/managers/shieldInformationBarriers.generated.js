...
class ShieldInformationBarriersManager {
    ...
    createShieldInformationBarrierChangeStatus(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barriers/change_status"), { method: "POST", body: JSON.stringify(requestBody), contentType: "application/json", auth: this.auth });
            return (0, schemas_generated_js_1.deserializeShieldInformationBarrier)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    createShieldInformationBarrier(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barriers"), { method: "POST", body: (0, json_js_2.serializeJson)((0, schemas_generated_js_2.serializeShieldInformationBarrier)(requestBody)), contentType: "application/json", auth: this.auth });
            return (0, schemas_generated_js_1.deserializeShieldInformationBarrier)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
