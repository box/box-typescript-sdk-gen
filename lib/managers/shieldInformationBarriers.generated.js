...
class ShieldInformationBarriersManager {
    ...
    getShieldInformationBarriersId(shieldInformationBarrierId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeShieldInformationBarrier)(deserializeJSON(response.text));
        });
    }
    ...
    postShieldInformationBarriers(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barriers"), { method: "POST", body: (0, schemas_generated_js_2.serializeShieldInformationBarrier)(serializeJSON(requestBody)), auth: this.auth });
            return (0, schemas_generated_js_1.deserializeShieldInformationBarrier)(deserializeJSON(response.text));
        });
    }
}
