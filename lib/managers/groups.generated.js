...
class GroupsManager {
    ...
    getGroups(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeGroups)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    postGroups(requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeGroup)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
