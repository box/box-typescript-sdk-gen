...
exports.newDeserializeGetFileVersionLegalHoldsQueryParamsArg = exports.newSerializeGetFileVersionLegalHoldsQueryParamsArg = exports.FileVersionLegalHoldsManager = void 0;
...
class FileVersionLegalHoldsManager {
    ...
    getFileVersionLegalHoldById(fileVersionLegalHoldId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.newDeserializeFileVersionLegalHold)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    getFileVersionLegalHolds(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.newDeserializeFileVersionLegalHolds)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
exports.FileVersionLegalHoldsManager = FileVersionLegalHoldsManager;
function newSerializeGetFileVersionLegalHoldsQueryParamsArg(val) {
    return { ["policyId"]: val.policyId, ["marker"]: val.marker, ["limit"]: val.limit };
}
exports.newSerializeGetFileVersionLegalHoldsQueryParamsArg = newSerializeGetFileVersionLegalHoldsQueryParamsArg;
function newDeserializeGetFileVersionLegalHoldsQueryParamsArg(val) {
...
exports.newDeserializeGetFileVersionLegalHoldsQueryParamsArg = newDeserializeGetFileVersionLegalHoldsQueryParamsArg;
