...
class FileVersionLegalHoldsManager {
    ...
    getFileVersionLegalHoldsId(fileVersionLegalHoldId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeFileVersionLegalHold)(deserializeJSON(response.text));
        });
    }
    getFileVersionLegalHolds(policyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeFileVersionLegalHolds)(deserializeJSON(response.text));
        });
    }
}
