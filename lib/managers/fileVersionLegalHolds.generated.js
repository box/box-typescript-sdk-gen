...
class FileVersionLegalHoldsManager {
    ...
    getFileVersionLegalHoldsId(fileVersionLegalHoldId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeFileVersionLegalHold)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    getFileVersionLegalHolds(policyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeFileVersionLegalHolds)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
}
