...
class GetFileMetadataGlobalBoxSkillsCardsHeadersArg {
    constructor(fields) {
        this.extraHeaders = {};
        Object.assign(this, fields);
    }
}
exports.GetFileMetadataGlobalBoxSkillsCardsHeadersArg = GetFileMetadataGlobalBoxSkillsCardsHeadersArg;
...
exports.CreateFileMetadataGlobalBoxSkillsCardHeadersArg = CreateFileMetadataGlobalBoxSkillsCardHeadersArg;
class DeleteFileMetadataGlobalBoxSkillsCardHeadersArg {
    constructor(fields) {
        this.extraHeaders = {};
        Object.assign(this, fields);
    }
}
exports.DeleteFileMetadataGlobalBoxSkillsCardHeadersArg = DeleteFileMetadataGlobalBoxSkillsCardHeadersArg;
class UpdateSkillInvocationByIdHeadersArg {
    constructor(fields) {
        this.extraHeaders = {};
        Object.assign(this, fields);
    }
}
exports.UpdateSkillInvocationByIdHeadersArg = UpdateSkillInvocationByIdHeadersArg;
class SkillsManager {
    constructor(fields) {
        Object.assign(this, fields);
    }
    getFileMetadataGlobalBoxSkillsCards(fileId, headers = new GetFileMetadataGlobalBoxSkillsCardsHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/metadata/global/boxSkillsCards"), { method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeSkillCardsMetadata)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    createFileMetadataGlobalBoxSkillsCard(fileId, requestBody, headers = new CreateFileMetadataGlobalBoxSkillsCardHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/metadata/global/boxSkillsCards"), { method: "POST", headers: headersMap, body: (0, json_js_2.serializeJson)(serializeCreateFileMetadataGlobalBoxSkillsCardRequestBodyArg(requestBody)), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeSkillCardsMetadata)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    deleteFileMetadataGlobalBoxSkillsCard(fileId, headers = new DeleteFileMetadataGlobalBoxSkillsCardHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/metadata/global/boxSkillsCards"), { method: "DELETE", headers: headersMap, responseFormat: void 0, auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
    updateSkillInvocationById(skillId, requestBody, headers = new UpdateSkillInvocationByIdHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/skill_invocations/", skillId), { method: "PUT", headers: headersMap, body: (0, json_js_2.serializeJson)(serializeUpdateSkillInvocationByIdRequestBodyArg(requestBody)), contentType: "application/json", responseFormat: void 0, auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
}
...
function deserializeUpdateSkillInvocationByIdRequestBodyArgMetadataField(val) {
    const cards = (0, json_js_3.isJson)(val.cards, "array") ? val.cards.map(function (itm) {
        return (0, schemas_generated_js_3.deserializeKeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard)(itm);
    }) : void 0;
    return { cards: cards };
}
...
function deserializeUpdateSkillInvocationByIdRequestBodyArgUsageField(val) {
    const unit = (0, json_js_3.isJson)(val.unit, "string") ? val.unit : void 0;
    const value = (0, json_js_3.isJson)(val.value, "number") ? val.value : void 0;
...
function deserializeUpdateSkillInvocationByIdRequestBodyArg(val) {
    ...
    const fileVersion = val.file_version == void 0 ? void 0 : deserializeUpdateSkillInvocationByIdRequestBodyArgFileVersionField(val.file_version);
