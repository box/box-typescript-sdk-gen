...
class SkillsManager {
    ...
    createFileMetadataGlobalBoxSkillsCard(fileId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/metadata/global/boxSkillsCards"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateFileMetadataGlobalBoxSkillsCardRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeSkillCardsMetadata)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    updateSkillInvocationById(skillId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/skill_invocations/", skillId), { method: "PUT", body: (0, json_js_2.serializeJson)(serializeUpdateSkillInvocationByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return response.content;
        });
    }
}
