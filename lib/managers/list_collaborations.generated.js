...
class ListCollaborationsManager {
    ...
    getFilesIdCollaborations(fileId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaborations)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    ...
    postCollaborations(requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaborations"), { method: "POST", params: { ["fields"]: options.fields, ["notify"]: options.notify }, body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeCollaboration)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
...
//# sourceMappingURL=list_collaborations.generated.js.map