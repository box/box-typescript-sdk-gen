...
class SharedLinksWebLinksManager {
    ...
    getSharedItemWebLinks(queryParams = {}, headers) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shared_items#web_links"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetSharedItemWebLinksQueryParamsArg(queryParams)), headers: (0, utils_js_1.prepareParams)(serializeGetSharedItemWebLinksHeadersArg(headers)), auth: this.auth, networkSession: this.networkSession });
    ...
    getWebLinkGetSharedLink(webLinkId, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/web_links/", webLinkId, "#get_shared_link"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetWebLinkGetSharedLinkQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeWebLink)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    updateWebLinkAddSharedLink(webLinkId, requestBody, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/web_links/", webLinkId, "#add_shared_link"), { method: "PUT", params: (0, utils_js_1.prepareParams)(serializeUpdateWebLinkAddSharedLinkQueryParamsArg(queryParams)), body: (0, json_js_2.serializeJson)(serializeUpdateWebLinkAddSharedLinkRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeWebLink)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    updateWebLinkUpdateSharedLink(webLinkId, requestBody, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/web_links/", webLinkId, "#update_shared_link"), { method: "PUT", params: (0, utils_js_1.prepareParams)(serializeUpdateWebLinkUpdateSharedLinkQueryParamsArg(queryParams)), body: (0, json_js_2.serializeJson)(serializeUpdateWebLinkUpdateSharedLinkRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeWebLink)((0, json_js_1.deserializeJson)(response.text));
        });
    }
