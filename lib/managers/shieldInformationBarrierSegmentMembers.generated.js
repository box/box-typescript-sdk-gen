...
class ShieldInformationBarrierSegmentMembersManager {
    ...
    getShieldInformationBarrierSegmentMembers(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barrier_segment_members"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
