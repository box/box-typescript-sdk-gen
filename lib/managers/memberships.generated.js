...
class MembershipsManager {
    ...
    getUserMemberships(userId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/users/", userId, "/memberships"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetUserMembershipsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    getGroupMemberships(groupId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/groups/", groupId, "/memberships"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetGroupMembershipsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeGroupMemberships)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    getGroupMembershipById(groupMembershipId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/group_memberships/", groupMembershipId), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetGroupMembershipByIdQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeGroupMembership)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    updateGroupMembershipById(groupMembershipId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/group_memberships/", groupMembershipId), { method: "PUT", params: (0, utils_js_1.prepareParams)(serializeUpdateGroupMembershipByIdQueryParamsArg(queryParams)), body: (0, json_js_2.serializeJson)(serializeUpdateGroupMembershipByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeGroupMembership)((0, json_js_1.deserializeJson)(response.text));
        });
    }
