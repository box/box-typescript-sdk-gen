...
class MembershipsManager {
    ...
    getUsersIdMemberships(userId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeGroupMemberships)(deserializeJSON(response.text));
        });
    }
    ...
    postGroupMemberships(requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeGroupMembership)(deserializeJSON(response.text));
        });
    }
