...
class SignRequestsManager {
    ...
    postSignRequestsIdCancel(signRequestId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeSignRequest)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    ...
    getSignRequests(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeSignRequests)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    postSignRequests(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/sign_requests"), { method: "POST", body: yield (0, schemas_generated_js_3.serializeSignRequestCreateRequest)((0, json_js_2.serializeJSON)(requestBody)), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeSignRequest)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
}
exports.SignRequestsManager = SignRequestsManager;
//# sourceMappingURL=sign_requests.generated.js.map