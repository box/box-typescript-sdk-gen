...
class ListCollaborationsManager {
    ...
    getFileCollaborations(fileId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeCollaborations)(deserializeJSON(response.text));
        });
    }
    ...
    createCollaboration(requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeCollaboration)(deserializeJSON(response.text));
        });
    }
