...
class ListCollaborationsManager {
    ...
    getFilesIdCollaborations(fileId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaborations)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    postCollaborations(requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeCollaboration)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
