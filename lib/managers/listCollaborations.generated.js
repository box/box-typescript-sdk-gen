...
class ListCollaborationsManager {
    ...
    getFileCollaborations(fileId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/collaborations"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetFileCollaborationsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    getFolderCollaborations(folderId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId, "/collaborations"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetFolderCollaborationsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeCollaborations)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    getCollaborations(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaborations"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetCollaborationsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeCollaborations)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    getGroupCollaborations(groupId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/groups/", groupId, "/collaborations"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetGroupCollaborationsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeCollaborations)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
