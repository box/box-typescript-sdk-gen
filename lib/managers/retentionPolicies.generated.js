...
class RetentionPoliciesManager {
    ...
    getRetentionPolicies(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeRetentionPolicies)(deserializeJSON(response.text));
        });
    }
    createRetentionPolicy(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeRetentionPolicy)(deserializeJSON(response.text));
        });
    }
