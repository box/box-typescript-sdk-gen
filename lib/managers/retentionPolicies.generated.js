...
class RetentionPoliciesManager {
    ...
    getRetentionPolicies(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeRetentionPolicies)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postRetentionPolicies(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeRetentionPolicy)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
