...
class RetentionPoliciesManager {
    ...
    getRetentionPolicies(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policies"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
    ...
    getRetentionPolicyById(retentionPolicyId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/retention_policies/", retentionPolicyId), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeRetentionPolicy)((0, json_js_1.deserializeJson)(response.text));
        });
    }
