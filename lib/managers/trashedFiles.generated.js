...
class TrashedFilesManager {
    ...
    restoreFileFromTrash(fileId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId), { method: "POST", params: (0, utils_js_1.prepareParams)(serializeRestoreFileFromTrashQueryParamsArg(queryParams)), body: (0, json_js_1.serializeJson)(serializeRestoreFileFromTrashRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    getFileTrash(fileId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/trash"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetFileTrashQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
