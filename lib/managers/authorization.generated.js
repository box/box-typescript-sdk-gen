...
class AuthorizationManager {
    ...
    getAuthorize(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://account.box.com/api/oauth2/authorize"), { method: "GET", params: (0, utils_js_1.prepareParams)(queryParams), auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
}
...
function deserializeGetAuthorizeQueryParamsArg(val) {
    const responseType = deserializeGetAuthorizeQueryParamsArgResponseTypeField(val.responseType);
