...
class CommentsManager {
    ...
    getFilesIdComments(fileId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeComments)(deserializeJSON(response.text));
        });
    }
    getCommentsId(commentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeComment)(deserializeJSON(response.text));
        });
    }
