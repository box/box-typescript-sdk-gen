...
class CommentsManager {
    ...
    getFilesIdComments(fileId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeComments)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    getCommentsId(commentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeComment)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
