...
class CommentsManager {
    ...
    getFileComments(fileId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/comments"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetFileCommentsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    getCommentById(commentId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/comments/", commentId), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetCommentByIdQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    updateCommentById(commentId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/comments/", commentId), { method: "PUT", params: (0, utils_js_1.prepareParams)(serializeUpdateCommentByIdQueryParamsArg(queryParams)), body: (0, json_js_2.serializeJson)(serializeUpdateCommentByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeCommentFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    createComment(requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/comments"), { method: "POST", params: (0, utils_js_1.prepareParams)(serializeCreateCommentQueryParamsArg(queryParams)), body: (0, json_js_2.serializeJson)(serializeCreateCommentRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
