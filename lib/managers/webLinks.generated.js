...
class WebLinksManager {
    ...
    createWebLink(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/web_links"), { method: "POST", body: (0, json_js_1.serializeJson)(serializeCreateWebLinkRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    getWebLinkById(webLinkId, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/web_links/", webLinkId), { method: "GET", headers: (0, utils_js_1.prepareParams)(serializeGetWebLinkByIdHeadersArg(headers)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeWebLink)((0, json_js_2.deserializeJson)(response.text));
        });
    }
    updateWebLinkById(webLinkId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/web_links/", webLinkId), { method: "PUT", body: (0, json_js_1.serializeJson)(serializeUpdateWebLinkByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeWebLink)((0, json_js_2.deserializeJson)(response.text));
        });
    }
...
function deserializeCreateWebLinkRequestBodyArg(val) {
    ...
    const sharedLink = val.shared_link == void 0 ? void 0 : deserializeCreateWebLinkRequestBodyArgSharedLinkField(val.shared_link);
