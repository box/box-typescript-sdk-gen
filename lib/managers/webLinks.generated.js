...
class WebLinksManager {
    ...
    postWebLinks(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeWebLink)(deserializeJSON(response.text));
        });
    }
    ...
    postWebLinksId(webLinkId, requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeTrashWebLinkRestored)(deserializeJSON(response.text));
        });
    }
