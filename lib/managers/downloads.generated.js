...
class DownloadsManager {
    ...
    downloadFile(fileId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/content"), { method: "GET", params: (0, utils_js_1.prepareParams)(queryParams), headers: (0, utils_js_1.prepareParams)(headers), auth: this.auth, networkSession: this.networkSession });
