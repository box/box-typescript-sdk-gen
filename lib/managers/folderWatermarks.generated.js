...
class FolderWatermarksManager {
    ...
    getFoldersIdWatermark(folderId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeWatermark)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    putFoldersIdWatermark(folderId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId, "/watermark"), { method: "PUT", body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeWatermark)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
