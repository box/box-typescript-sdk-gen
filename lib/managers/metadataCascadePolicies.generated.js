...
class MetadataCascadePoliciesManager {
    ...
    getMetadataCascadePolicies(folderId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeMetadataCascadePolicies)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postMetadataCascadePolicies(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeMetadataCascadePolicy)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
