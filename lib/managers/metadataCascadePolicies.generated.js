...
class MetadataCascadePoliciesManager {
    ...
    getMetadataCascadePolicies(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_cascade_policies"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetMetadataCascadePoliciesQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    createMetadataCascadePolicy(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_cascade_policies"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateMetadataCascadePolicyRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    createMetadataCascadePolicyApply(metadataCascadePolicyId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_cascade_policies/", metadataCascadePolicyId, "/apply"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateMetadataCascadePolicyApplyRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return response.content;
        });
    }
}
...
function deserializeGetMetadataCascadePoliciesQueryParamsArg(val) {
    ...
    const ownerEnterpriseId = (0, json_js_3.isJson)(val.owner_enterprise_id, "string") ? val.owner_enterprise_id : void 0;
