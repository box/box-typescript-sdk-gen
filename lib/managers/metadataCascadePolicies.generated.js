...
class MetadataCascadePoliciesManager {
    ...
    getMetadataCascadePolicies(folderId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeMetadataCascadePolicies)(deserializeJSON(response.text));
        });
    }
    postMetadataCascadePolicies(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeMetadataCascadePolicy)(deserializeJSON(response.text));
        });
    }
