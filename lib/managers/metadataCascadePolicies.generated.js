...
class MetadataCascadePoliciesManager {
    ...
    getMetadataCascadePolicies(folderId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeMetadataCascadePolicies)(deserializeJSON(response.text));
        });
    }
    postMetadataCascadePolicies(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_cascade_policies"), { method: "POST", body: json_js_1.JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeMetadataCascadePolicy)(deserializeJSON(response.text));
        });
    }
    ...
    postMetadataCascadePoliciesIdApply(metadataCascadePolicyId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_cascade_policies/", metadataCascadePolicyId, "/apply"), { method: "POST", body: json_js_1.JSON.stringify(requestBody), auth: this.auth });
            return response.content;
        });
    }
}
