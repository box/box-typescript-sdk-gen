...
class WebhooksManager {
    ...
    getWebhooks(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeWebhooks)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postWebhooks(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeWebhook)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
