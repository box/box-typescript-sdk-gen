...
class WebhooksManager {
    ...
    getWebhooks(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/webhooks"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetWebhooksQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeWebhooks)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    createWebhook(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/webhooks"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateWebhookRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    updateWebhookById(webhookId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/webhooks/", webhookId), { method: "PUT", body: (0, json_js_2.serializeJson)(serializeUpdateWebhookByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeWebhook)((0, json_js_1.deserializeJson)(response.text));
        });
    }
...
function serializeGetWebhooksQueryParamsArg(val) {
    return { ["marker"]: val.marker, ["limit"]: val.limit };
}
exports.serializeGetWebhooksQueryParamsArg = serializeGetWebhooksQueryParamsArg;
function deserializeGetWebhooksQueryParamsArg(val) {
...
exports.deserializeGetWebhooksQueryParamsArg = deserializeGetWebhooksQueryParamsArg;
