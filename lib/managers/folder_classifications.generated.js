...
class FolderClassificationsManager {
    ...
    postFoldersIdMetadataEnterpriseSecurityClassification6VmVochwUWo(folderId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folders/", folderId, "/metadata/enterprise/securityClassification-6VMVochwUWo"), { method: "POST", body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeClassification)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
...
//# sourceMappingURL=folder_classifications.generated.js.map