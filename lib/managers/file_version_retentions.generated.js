...
class FileVersionRetentionsManager {
    ...
    getFileVersionRetentions(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeFileVersionRetentions)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    getFileVersionRetentionsId(fileVersionRetentionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeFileVersionRetention)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
}
exports.FileVersionRetentionsManager = FileVersionRetentionsManager;
//# sourceMappingURL=file_version_retentions.generated.js.map