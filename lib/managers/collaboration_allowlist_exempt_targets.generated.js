...
class CollaborationAllowlistExemptTargetsManager {
    ...
    getCollaborationWhitelistExemptTargets(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaborationAllowlistExemptTargets)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    postCollaborationWhitelistExemptTargets(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaboration_whitelist_exempt_targets"), { method: "POST", body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeCollaborationAllowlistExemptTarget)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    getCollaborationWhitelistExemptTargetsId(collaborationWhitelistExemptTargetId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteCollaborationWhitelistExemptTargetsId(collaborationWhitelistExemptTargetId) {
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=collaboration_allowlist_exempt_targets.generated.js.map