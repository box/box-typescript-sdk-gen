...
class WorkflowsManager {
    ...
    createWorkflowStart(workflowId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/workflows/", workflowId, "/start"), { method: "POST", body: JSON.stringify(requestBody), contentType: "application/json", auth: this.auth });
