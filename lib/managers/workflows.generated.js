...
class GetWorkflowsHeadersArg {
    constructor(fields) {
        this.extraHeaders = {};
        Object.assign(this, fields);
    }
}
exports.GetWorkflowsHeadersArg = GetWorkflowsHeadersArg;
class CreateWorkflowStartHeadersArg {
    constructor(fields) {
        this.extraHeaders = {};
        Object.assign(this, fields);
    }
}
exports.CreateWorkflowStartHeadersArg = CreateWorkflowStartHeadersArg;
class WorkflowsManager {
    constructor(fields) {
        Object.assign(this, fields);
    }
    getWorkflows(queryParams, headers = new GetWorkflowsHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/workflows"), { method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeWorkflows)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    createWorkflowStart(workflowId, requestBody, headers = new CreateWorkflowStartHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/workflows/", workflowId, "/start"), { method: "POST", headers: headersMap, body: (0, json_js_2.serializeJson)(serializeCreateWorkflowStartRequestBodyArg(requestBody)), contentType: "application/json", responseFormat: void 0, auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
}
