...
class WorkflowsManager {
    ...
    getWorkflows(folderId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeWorkflows)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postWorkflowsIdStart(workflowId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/workflows/", workflowId, "/start"), { method: "POST", body: JSON.stringify(requestBody), auth: this.auth });
