...
class TermsOfServicesManager {
    ...
    getTermOfServices(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_services"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
