...
class TermsOfServicesManager {
    ...
    getTermOfServices(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_services"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetTermOfServicesQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    createTermOfService(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_services"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateTermOfServiceRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    updateTermOfServiceById(termsOfServiceId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/terms_of_services/", termsOfServiceId), { method: "PUT", body: (0, json_js_2.serializeJson)(serializeUpdateTermOfServiceByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_3.deserializeTermsOfService)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
...
function deserializeGetTermOfServicesQueryParamsArg(val) {
    const tosType = val.tos_type == void 0 ? void 0 : deserializeGetTermOfServicesQueryParamsArgTosTypeField(val.tos_type);
