...
class DevicePinnersManager {
    ...
    getDevicePinnersId(devicePinnerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeDevicePinner)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    deleteDevicePinnersId(devicePinnerId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getEnterprisesIdDevicePinners(enterpriseId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeDevicePinners)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
}
exports.DevicePinnersManager = DevicePinnersManager;
//# sourceMappingURL=device_pinners.generated.js.map