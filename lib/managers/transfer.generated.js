...
class TransferManager {
    ...
    transferOwnedFolder(userId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/users/", userId, "/folders/0"), { method: "PUT", params: (0, utils_js_1.prepareParams)(serializeTransferOwnedFolderQueryParamsArg(queryParams)), body: (0, json_js_1.serializeJson)(serializeTransferOwnedFolderRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
