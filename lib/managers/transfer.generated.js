...
class TransferManager {
    ...
    transferOwnedFolder(userId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/users/", userId, "/folders/0"), { method: "PUT", params: (0, utils_js_1.prepareParams)(queryParams), body: JSON.stringify(requestBody), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
...
function serializeTransferOwnedFolderRequestBodyArg(val) {
    return { ["ownedBy"]: serializeTransferOwnedFolderRequestBodyArgOwnedByField(val.ownedBy) };
}
...
function deserializeTransferOwnedFolderRequestBodyArg(val) {
    const ownedBy = deserializeTransferOwnedFolderRequestBodyArgOwnedByField(val.ownedBy);
