...
class SignTemplatesManager {
    ...
    getSignTemplates(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/sign_templates"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetSignTemplatesQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
