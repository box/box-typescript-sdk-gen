...
exports.newDeserializeGetSignTemplatesQueryParamsArg = exports.newSerializeGetSignTemplatesQueryParamsArg = exports.SignTemplatesManager = void 0;
...
class SignTemplatesManager {
    ...
    getSignTemplates(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.newDeserializeSignTemplates)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    getSignTemplateById(templateId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.newDeserializeSignTemplate)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
exports.SignTemplatesManager = SignTemplatesManager;
function newSerializeGetSignTemplatesQueryParamsArg(val) {
    return { ["marker"]: val.marker, ["limit"]: val.limit };
}
exports.newSerializeGetSignTemplatesQueryParamsArg = newSerializeGetSignTemplatesQueryParamsArg;
function newDeserializeGetSignTemplatesQueryParamsArg(val) {
...
exports.newDeserializeGetSignTemplatesQueryParamsArg = newDeserializeGetSignTemplatesQueryParamsArg;
