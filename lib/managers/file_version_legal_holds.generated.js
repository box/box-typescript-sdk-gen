...
class FileVersionLegalHoldsManager {
    ...
    getFileVersionLegalHoldsId(fileVersionLegalHoldId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeFileVersionLegalHold)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    getFileVersionLegalHolds(policyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeFileVersionLegalHolds)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
}
exports.FileVersionLegalHoldsManager = FileVersionLegalHoldsManager;
//# sourceMappingURL=file_version_legal_holds.generated.js.map