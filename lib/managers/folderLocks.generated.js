...
class FolderLocksManager {
    ...
    getFolderLocks(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/folder_locks"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
