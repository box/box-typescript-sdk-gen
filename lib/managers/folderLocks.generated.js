...
class FolderLocksManager {
    ...
    getFolderLocks(folderId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeFolderLocks)(deserializeJSON(response.text));
        });
    }
    postFolderLocks(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeFolderLock)(deserializeJSON(response.text));
        });
    }
