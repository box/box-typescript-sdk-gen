...
class UserCollaborationsManager {
    ...
    getCollaborationById(collaborationId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaborations/", collaborationId), { method: "GET", params: (0, utils_js_1.prepareParams)(queryParams), auth: this.auth, networkSession: this.networkSession });
    ...
    createCollaboration(requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaborations"), { method: "POST", params: (0, utils_js_1.prepareParams)(queryParams), body: JSON.stringify(requestBody), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeCollaboration)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
...
function deserializeCreateCollaborationRequestBodyArg(val) {
    ...
    const accessibleBy = deserializeCreateCollaborationRequestBodyArgAccessibleByField(val.accessibleBy);
