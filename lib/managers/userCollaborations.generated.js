...
class UserCollaborationsManager {
    ...
    getCollaborationsId(collaborationId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaboration)(deserializeJSON(response.text));
        });
    }
    putCollaborationsId(collaborationId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaborations/", collaborationId), { method: "PUT", body: json_js_1.JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeCollaboration)(deserializeJSON(response.text));
        });
    }
