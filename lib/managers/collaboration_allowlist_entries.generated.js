...
class CollaborationAllowlistEntriesManager {
    ...
    getCollaborationWhitelistEntries(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaborationAllowlistEntries)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
    postCollaborationWhitelistEntries(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaboration_whitelist_entries"), { method: "POST", body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeCollaborationAllowlistEntry)((0, json_js_1.deserializeJSON)(response.text));
        });
    }
...
//# sourceMappingURL=collaboration_allowlist_entries.generated.js.map