...
class LegalHoldPoliciesManager {
    ...
    getLegalHoldPolicies(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeLegalHoldPolicies)(deserializeJSON(response.text));
        });
    }
    postLegalHoldPolicies(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeLegalHoldPolicy)(deserializeJSON(response.text));
        });
    }
