...
class DevicePinnersManager {
    ...
    getDevicePinnersId(devicePinnerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeDevicePinner)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    getEnterprisesIdDevicePinners(enterpriseId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeDevicePinners)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
}
