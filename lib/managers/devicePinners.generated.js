...
class DevicePinnersManager {
    ...
    getDevicePinnersId(devicePinnerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeDevicePinner)(deserializeJSON(response.text));
        });
    }
    ...
    getEnterprisesIdDevicePinners(enterpriseId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeDevicePinners)(deserializeJSON(response.text));
        });
    }
}
