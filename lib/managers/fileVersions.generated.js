...
class FileVersionsManager {
    ...
    getFilesIdVersions(fileId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeFileVersions)(deserializeJSON(response.text));
        });
    }
    getFilesIdVersionsId(fileId, fileVersionId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeFileVersion)(deserializeJSON(response.text));
        });
    }
