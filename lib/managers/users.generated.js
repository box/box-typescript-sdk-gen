...
class UsersManager {
    ...
    getUsers(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeUsers)(deserializeJSON(response.text));
        });
    }
    postUsers(requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeUser)(deserializeJSON(response.text));
        });
    }
    getUsersMe(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
