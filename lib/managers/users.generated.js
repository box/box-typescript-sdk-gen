...
class UsersManager {
    ...
    getUsers(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeUsers)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postUsers(requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/users"), { method: "POST", params: { ["fields"]: options.fields }, body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeUser)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    getUsersMe(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    putUsersId(userId, requestBody, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/users/", userId), { method: "PUT", params: { ["fields"]: options.fields }, body: JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeUser)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
