...
class LegalHoldPolicyAssignmentsManager {
    ...
    getLegalHoldPolicyAssignments(policyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeLegalHoldPolicyAssignments)(deserializeJSON(response.text));
        });
    }
    createLegalHoldPolicyAssignment(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/legal_hold_policy_assignments"), { method: "POST", body: json_js_1.JSON.stringify(requestBody), auth: this.auth });
            return (0, schemas_generated_js_2.deserializeLegalHoldPolicyAssignment)(deserializeJSON(response.text));
        });
    }
    ...
    getLegalHoldPolicyAssignmentFileOnHold(legalHoldPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_3.deserializeFileVersionLegalHolds)(deserializeJSON(response.text));
        });
    }
