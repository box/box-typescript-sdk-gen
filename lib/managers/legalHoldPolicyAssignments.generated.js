...
class LegalHoldPolicyAssignmentsManager {
    ...
    getLegalHoldPolicyAssignments(policyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeLegalHoldPolicyAssignments)(deserializeJSON(response.text));
        });
    }
    postLegalHoldPolicyAssignments(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeLegalHoldPolicyAssignment)(deserializeJSON(response.text));
        });
    }
    ...
    getLegalHoldPolicyAssignmentsIdFilesOnHold(legalHoldPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeFileVersionLegalHolds)(deserializeJSON(response.text));
        });
    }
