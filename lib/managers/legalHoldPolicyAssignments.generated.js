...
class LegalHoldPolicyAssignmentsManager {
    ...
    getLegalHoldPolicyAssignments(policyId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeLegalHoldPolicyAssignments)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postLegalHoldPolicyAssignments(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeLegalHoldPolicyAssignment)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    ...
    getLegalHoldPolicyAssignmentsIdFilesOnHold(legalHoldPolicyAssignmentId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeFileVersionLegalHolds)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
