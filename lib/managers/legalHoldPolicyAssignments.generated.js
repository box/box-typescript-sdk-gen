...
class LegalHoldPolicyAssignmentsManager {
    ...
    getLegalHoldPolicyAssignments(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/legal_hold_policy_assignments"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetLegalHoldPolicyAssignmentsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    getLegalHoldPolicyAssignmentFileOnHold(legalHoldPolicyAssignmentId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/legal_hold_policy_assignments/", legalHoldPolicyAssignmentId, "/files_on_hold"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetLegalHoldPolicyAssignmentFileOnHoldQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    getLegalHoldPolicyAssignmentFileVersionOnHold(legalHoldPolicyAssignmentId, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/legal_hold_policy_assignments/", legalHoldPolicyAssignmentId, "/file_versions_on_hold"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetLegalHoldPolicyAssignmentFileVersionOnHoldQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_3.deserializeFileVersionLegalHolds)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
