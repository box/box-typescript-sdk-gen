...
class SearchManager {
    ...
    postMetadataQueriesExecuteRead(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_queries/execute_read"), { method: "POST", body: yield (0, schemas_generated_js_2.serializeMetadataQuery)((0, json_js_1.serializeJSON)(requestBody)), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeMetadataQueryResults)((0, json_js_2.deserializeJSON)(response.text));
        });
    }
    getMetadataQueryIndices(scope, templateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeMetadataQueryIndices)((0, json_js_2.deserializeJSON)(response.text));
        });
    }
    getSearch(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
