...
class SearchManager {
    ...
    postMetadataQueriesExecuteRead(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_queries/execute_read"), { method: "POST", body: (0, schemas_generated_js_2.serializeMetadataQuery)(serializeJSON(requestBody)), auth: this.auth });
            return (0, schemas_generated_js_1.deserializeMetadataQueryResults)(deserializeJSON(response.text));
        });
    }
    getMetadataQueryIndices(scope, templateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_3.deserializeMetadataQueryIndices)(deserializeJSON(response.text));
        });
    }
    getSearch(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
