...
class SearchManager {
    ...
    getMetadataQueryIndices(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_query_indices"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
    ...
    getSearch(queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/search"), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
