...
class SearchManager {
    ...
    postMetadataQueriesExecuteRead(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_queries/execute_read"), { method: "POST", body: yield (0, schemas_generated_js_2.serializeMetadataQuery)(yield (0, json_js_1.serializeJson)(requestBody)), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeMetadataQueryResults)(yield (0, json_js_2.deserializeJson)(response.text));
        });
    }
    getMetadataQueryIndices(scope, templateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_query_indices"), { method: "GET", params: { ["scope"]: scope, ["template_key"]: templateKey }, auth: this.auth });
            return yield (0, schemas_generated_js_3.deserializeMetadataQueryIndices)(yield (0, json_js_2.deserializeJson)(response.text));
        });
    }
    getSearch(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/search"), { method: "GET", params: { ["query"]: options.query, ["scope"]: options.scope, ["file_extensions"]: options.fileExtensions, ["created_at_range"]: options.createdAtRange, ["updated_at_range"]: options.updatedAtRange, ["size_range"]: options.sizeRange, ["owner_user_ids"]: options.ownerUserIds, ["recent_updater_user_ids"]: options.recentUpdaterUserIds, ["ancestor_folder_ids"]: options.ancestorFolderIds, ["content_types"]: options.contentTypes, ["type"]: options.type, ["trash_content"]: options.trashContent, ["mdfilters"]: options.mdfilters, ["sort"]: options.sort, ["direction"]: options.direction, ["limit"]: options.limit, ["include_recent_shared_links"]: options.includeRecentSharedLinks, ["fields"]: options.fields, ["offset"]: options.offset }, auth: this.auth });
            return void 0;
        });
    }
}
