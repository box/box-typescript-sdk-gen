...
class FilesManager {
    ...
    getFileById(fileId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headersMap = (0, utils_js_1.prepareParams)({ ["if-none-match"]: (0, utils_js_2.toString)(headers.ifNoneMatch), ["boxapi"]: (0, utils_js_2.toString)(headers.boxapi), ["x-rep-hints"]: (0, utils_js_2.toString)(headers.xRepHints) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId), { method: "GET", params: queryParamsMap, headers: headersMap, auth: this.auth, networkSession: this.networkSession });
    ...
    updateFileById(fileId, requestBody, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId), { method: "PUT", params: queryParamsMap, headers: headersMap, body: (0, json_js_2.serializeJson)(serializeUpdateFileByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFileFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    deleteFileById(fileId, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)({ ["if-match"]: (0, utils_js_2.toString)(headers.ifMatch) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId), { method: "DELETE", headers: headersMap, auth: this.auth, networkSession: this.networkSession });
    ...
    copyFile(fileId, requestBody, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["fields"]: (0, utils_js_2.toString)(queryParams.fields) });
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/copy"), { method: "POST", params: queryParamsMap, body: (0, json_js_2.serializeJson)(serializeCopyFileRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFileFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    getFileThumbnailById(fileId, extension, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/thumbnail.", extension), { method: "GET", params: queryParamsMap, auth: this.auth, networkSession: this.networkSession });
            return response.content;
        });
    }
}
...
function deserializeGetFileByIdHeadersArg(val) {
    ...
    const xRepHints = (0, json_js_3.isJson)(val["x-rep-hints"], "string") ? val["x-rep-hints"] : void 0;
...
function deserializeGetFileThumbnailByIdQueryParamsArg(val) {
    const minHeight = (0, json_js_3.isJson)(val.min_height, "number") ? val.min_height : void 0;
    const minWidth = (0, json_js_3.isJson)(val.min_width, "number") ? val.min_width : void 0;
    const maxHeight = (0, json_js_3.isJson)(val.max_height, "number") ? val.max_height : void 0;
    const maxWidth = (0, json_js_3.isJson)(val.max_width, "number") ? val.max_width : void 0;
