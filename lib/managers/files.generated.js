...
class FilesManager {
    ...
    getFileById(fileId, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetFileByIdQueryParamsArg(queryParams)), headers: (0, utils_js_1.prepareParams)(serializeGetFileByIdHeadersArg(headers)), auth: this.auth, networkSession: this.networkSession });
    ...
    updateFileById(fileId, requestBody, queryParams = {}, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId), { method: "PUT", params: (0, utils_js_1.prepareParams)(serializeUpdateFileByIdQueryParamsArg(queryParams)), headers: (0, utils_js_1.prepareParams)(serializeUpdateFileByIdHeadersArg(headers)), body: (0, json_js_2.serializeJson)(serializeUpdateFileByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeFileFull)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    deleteFileById(fileId, headers = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId), { method: "DELETE", headers: (0, utils_js_1.prepareParams)(serializeDeleteFileByIdHeadersArg(headers)), auth: this.auth, networkSession: this.networkSession });
    ...
    getFileThumbnailById(fileId, extension, queryParams = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/files/", fileId, "/thumbnail.", extension), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetFileThumbnailByIdQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return response.content;
        });
    }
}
