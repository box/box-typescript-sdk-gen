...
class TaskAssignmentsManager {
    ...
    getTasksIdAssignments(taskId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeTaskAssignments)(deserializeJSON(response.text));
        });
    }
    postTaskAssignments(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeTaskAssignment)(deserializeJSON(response.text));
        });
    }
