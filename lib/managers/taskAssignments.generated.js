...
function deserializeCreateTaskAssignmentRequestBodyArg(val) {
    ...
    const assignTo = deserializeCreateTaskAssignmentRequestBodyArgAssignToField(val.assignTo);
...
function deserializeUpdateTaskAssignmentByIdRequestBodyArg(val) {
    ...
    const resolutionState = val.resolutionState == void 0 ? void 0 : deserializeUpdateTaskAssignmentByIdRequestBodyArgResolutionStateField(val.resolutionState);
