...
class ShieldInformationBarrierSegmentsManager {
    ...
    getShieldInformationBarrierSegments(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barrier_segments"), { method: "GET", params: (0, utils_js_1.prepareParams)(queryParams), auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
...
function serializeCreateShieldInformationBarrierSegmentRequestBodyArg(val) {
    return { ["shieldInformationBarrier"]: (0, schemas_generated_js_2.serializeShieldInformationBarrierBase)(val.shieldInformationBarrier), ["name"]: val.name, ["description"]: val.description };
}
...
function deserializeCreateShieldInformationBarrierSegmentRequestBodyArg(val) {
    const shieldInformationBarrier = (0, schemas_generated_js_3.deserializeShieldInformationBarrierBase)(val.shieldInformationBarrier);
    const name = val.name;
    const description = (0, json_js_2.isJson)(val.description, "string") ? val.description : void 0;
