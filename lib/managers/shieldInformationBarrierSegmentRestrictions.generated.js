...
class ShieldInformationBarrierSegmentRestrictionsManager {
    ...
    getShieldInformationBarrierSegmentRestrictions(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barrier_segment_restrictions"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetShieldInformationBarrierSegmentRestrictionsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
    createShieldInformationBarrierSegmentRestriction(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barrier_segment_restrictions"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateShieldInformationBarrierSegmentRestrictionRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeShieldInformationBarrierSegmentRestriction)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
...
function deserializeGetShieldInformationBarrierSegmentRestrictionsQueryParamsArg(val) {
    const shieldInformationBarrierSegmentId = val.shield_information_barrier_segment_id;
