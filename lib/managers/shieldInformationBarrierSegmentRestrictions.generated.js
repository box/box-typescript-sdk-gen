...
class ShieldInformationBarrierSegmentRestrictionsManager {
    ...
    getShieldInformationBarrierSegmentRestrictionsId(shieldInformationBarrierSegmentRestrictionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeShieldInformationBarrierSegmentRestriction)(deserializeJSON(response.text));
        });
    }
    ...
    postShieldInformationBarrierSegmentRestrictions(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barrier_segment_restrictions"), { method: "POST", body: json_js_1.JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeShieldInformationBarrierSegmentRestriction)(deserializeJSON(response.text));
        });
    }
}
