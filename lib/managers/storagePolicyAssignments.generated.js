...
class StoragePolicyAssignmentsManager {
    ...
    getStoragePolicyAssignments(resolvedForType, resolvedForId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeStoragePolicyAssignments)(deserializeJSON(response.text));
        });
    }
    postStoragePolicyAssignments(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeStoragePolicyAssignment)(deserializeJSON(response.text));
        });
    }
