...
class StoragePolicyAssignmentsManager {
    ...
    getStoragePolicyAssignments(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/storage_policy_assignments"), { method: "GET", params: (0, utils_js_1.prepareParams)(serializeGetStoragePolicyAssignmentsQueryParamsArg(queryParams)), auth: this.auth, networkSession: this.networkSession });
    ...
    createStoragePolicyAssignment(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/storage_policy_assignments"), { method: "POST", body: (0, json_js_2.serializeJson)(serializeCreateStoragePolicyAssignmentRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
    ...
    updateStoragePolicyAssignmentById(storagePolicyAssignmentId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/storage_policy_assignments/", storagePolicyAssignmentId), { method: "PUT", body: (0, json_js_2.serializeJson)(serializeUpdateStoragePolicyAssignmentByIdRequestBodyArg(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_2.deserializeStoragePolicyAssignment)((0, json_js_1.deserializeJson)(response.text));
        });
    }
...
function deserializeGetStoragePolicyAssignmentsQueryParamsArg(val) {
    ...
    const resolvedForType = deserializeGetStoragePolicyAssignmentsQueryParamsArgResolvedForTypeField(val.resolved_for_type);
    const resolvedForId = val.resolved_for_id;
