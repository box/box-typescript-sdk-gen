...
class StoragePolicyAssignmentsManager {
    ...
    getStoragePolicyAssignments(resolvedForType, resolvedForId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/storage_policy_assignments"), { method: "GET", params: { ["marker"]: options.marker, ["resolved_for_type"]: resolvedForType, ["resolved_for_id"]: resolvedForId }, auth: this.auth, networkSession: this.networkSession });
