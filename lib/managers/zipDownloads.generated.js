...
class ZipDownloadsManager {
    ...
    createZipDownload(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/zip_downloads"), { method: "POST", body: (0, json_js_1.serializeJson)((0, schemas_generated_js_2.serializeZipDownloadRequest)(requestBody)), contentType: "application/json", auth: this.auth });
    ...
    getZipDownloadContent(zipDownloadId) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://dl.boxcloud.com/2.0/zip_downloads/", zipDownloadId, "/content"), { method: "GET", auth: this.auth });
