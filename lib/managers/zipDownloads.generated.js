...
class ZipDownloadsManager {
    ...
    postZipDownloads(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/zip_downloads"), { method: "POST", body: yield (0, schemas_generated_js_2.serializeZipDownloadRequest)(serializeJSON(requestBody)), auth: this.auth });
            return yield (0, schemas_generated_js_1.deserializeZipDownload)(deserializeJSON(response.text));
        });
    }
    ...
    getZipDownloadsIdStatus(zipDownloadId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_3.deserializeZipDownloadStatus)(deserializeJSON(response.text));
        });
    }
}
