...
class ZipDownloadsManager {
    ...
    createZipDownload(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/zip_downloads"), { method: "POST", body: (0, json_js_1.serializeJson)((0, schemas_generated_js_2.newSerializeZipDownloadRequest)(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.newDeserializeZipDownload)((0, json_js_2.deserializeJson)(response.text));
        });
    }
    ...
    getZipDownloadStatus(zipDownloadId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_3.newDeserializeZipDownloadStatus)((0, json_js_2.deserializeJson)(response.text));
        });
    }
}
