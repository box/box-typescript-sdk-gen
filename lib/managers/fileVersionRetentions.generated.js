...
class FileVersionRetentionsManager {
    ...
    getFileVersionRetentions(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeFileVersionRetentions)(deserializeJSON(response.text));
        });
    }
    getFileVersionRetentionById(fileVersionRetentionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeFileVersionRetention)(deserializeJSON(response.text));
        });
    }
}
