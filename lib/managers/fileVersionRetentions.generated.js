...
class FileVersionRetentionsManager {
    ...
    getFileVersionRetentions(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeFileVersionRetentions)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    getFileVersionRetentionsId(fileVersionRetentionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeFileVersionRetention)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
}
