...
class ClassificationsManager {
    ...
    getMetadataTemplateEnterpriseSecurityClassification6VmVochwUWoSchema() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeClassificationTemplate)(deserializeJSON(response.text));
        });
    }
    deleteMetadataTemplateEnterpriseSecurityClassification6VmVochwUWoSchema() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createMetadataTemplateSchemaClassification(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_templates/schema#classifications"), { method: "POST", body: json_js_1.JSON.stringify(requestBody), auth: this.auth });
            return (0, schemas_generated_js_1.deserializeClassificationTemplate)(deserializeJSON(response.text));
        });
    }
}
