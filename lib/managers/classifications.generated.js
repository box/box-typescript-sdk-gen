...
class GetMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg {
    constructor(fields) {
        this.extraHeaders = {};
        Object.assign(this, fields);
    }
}
exports.GetMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg = GetMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg;
class DeleteMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg {
    constructor(fields) {
        this.extraHeaders = {};
        Object.assign(this, fields);
    }
}
exports.DeleteMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg = DeleteMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg;
...
exports.CreateMetadataTemplateSchemaClassificationHeadersArg = CreateMetadataTemplateSchemaClassificationHeadersArg;
class ClassificationsManager {
    constructor(fields) {
        Object.assign(this, fields);
    }
    getMetadataTemplateEnterpriseSecurityClassificationSchema(headers = new GetMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_templates/enterprise/securityClassification-6VMVochwUWo/schema"), { method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeClassificationTemplate)((0, json_js_1.deserializeJson)(response.text));
        });
    }
    deleteMetadataTemplateEnterpriseSecurityClassificationSchema(headers = new DeleteMetadataTemplateEnterpriseSecurityClassificationSchemaHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_templates/enterprise/securityClassification-6VMVochwUWo/schema"), { method: "DELETE", headers: headersMap, responseFormat: void 0, auth: this.auth, networkSession: this.networkSession });
            return void 0;
        });
    }
    createMetadataTemplateSchemaClassification(requestBody, headers = new CreateMetadataTemplateSchemaClassificationHeadersArg({})) {
        return __awaiter(this, void 0, void 0, function* () {
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/metadata_templates/schema#classifications"), { method: "POST", headers: headersMap, body: (0, json_js_2.serializeJson)(serializeCreateMetadataTemplateSchemaClassificationRequestBodyArg(requestBody)), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.deserializeClassificationTemplate)((0, json_js_1.deserializeJson)(response.text));
        });
    }
}
