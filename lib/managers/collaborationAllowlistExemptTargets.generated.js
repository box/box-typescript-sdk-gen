...
class CollaborationAllowlistExemptTargetsManager {
    ...
    getCollaborationWhitelistExemptTargets(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_1.deserializeCollaborationAllowlistExemptTargets)(deserializeJSON(response.text));
        });
    }
    postCollaborationWhitelistExemptTargets(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, schemas_generated_js_2.deserializeCollaborationAllowlistExemptTarget)(deserializeJSON(response.text));
        });
    }
