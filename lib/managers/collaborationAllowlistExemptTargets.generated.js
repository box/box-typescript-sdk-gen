...
class CollaborationAllowlistExemptTargetsManager {
    ...
    getCollaborationWhitelistExemptTargets(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaborationAllowlistExemptTargets)(deserializeJSON(response.text));
        });
    }
    postCollaborationWhitelistExemptTargets(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/collaboration_whitelist_exempt_targets"), { method: "POST", body: json_js_1.JSON.stringify(requestBody), auth: this.auth });
            return yield (0, schemas_generated_js_2.deserializeCollaborationAllowlistExemptTarget)(deserializeJSON(response.text));
        });
    }
