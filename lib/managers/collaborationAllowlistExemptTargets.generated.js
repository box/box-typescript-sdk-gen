...
class CollaborationAllowlistExemptTargetsManager {
    ...
    getCollaborationWhitelistExemptTargets(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeCollaborationAllowlistExemptTargets)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
    postCollaborationWhitelistExemptTargets(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeCollaborationAllowlistExemptTarget)(yield (0, json_js_1.deserializeJson)(response.text));
        });
    }
