...
exports.newDeserializeGetShieldInformationBarrierReportsQueryParamsArg = exports.newSerializeGetShieldInformationBarrierReportsQueryParamsArg = exports.ShieldInformationBarrierReportsManager = void 0;
...
class ShieldInformationBarrierReportsManager {
    ...
    createShieldInformationBarrierReport(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, fetch_js_1.fetch)("".concat("https://api.box.com/2.0/shield_information_barrier_reports"), { method: "POST", body: (0, json_js_1.serializeJson)((0, schemas_generated_js_2.newSerializeShieldInformationBarrierReference)(requestBody)), contentType: "application/json", auth: this.auth, networkSession: this.networkSession });
            return (0, schemas_generated_js_1.newDeserializeShieldInformationBarrierReport)((0, json_js_2.deserializeJson)(response.text));
        });
    }
...
function newSerializeGetShieldInformationBarrierReportsQueryParamsArg(val) {
    return { ["shieldInformationBarrierId"]: val.shieldInformationBarrierId, ["marker"]: val.marker, ["limit"]: val.limit };
}
exports.newSerializeGetShieldInformationBarrierReportsQueryParamsArg = newSerializeGetShieldInformationBarrierReportsQueryParamsArg;
function newDeserializeGetShieldInformationBarrierReportsQueryParamsArg(val) {
...
exports.newDeserializeGetShieldInformationBarrierReportsQueryParamsArg = newDeserializeGetShieldInformationBarrierReportsQueryParamsArg;
