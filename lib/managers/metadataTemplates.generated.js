...
class MetadataTemplatesManager {
    ...
    getMetadataTemplates(metadataInstanceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_1.deserializeMetadataTemplates)(deserializeJSON(response.text));
        });
    }
    getMetadataTemplatesIdIdSchema(scope, templateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, schemas_generated_js_2.deserializeMetadataTemplate)(deserializeJSON(response.text));
        });
    }
