    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (options.multipartData) {
            ...
            for (const item of options.multipartData) {
                if (item.fileStream) {
                    let buffer;
                    if (item.fileStream instanceof fs_1.ReadStream) {
                        // We need to read the stream to calculate the MD5 hash
                        buffer = yield readFilestream(item.fileStream);
                    }
                    else {
        ...
        fetchOptions = {
            method,
            headers: Object.assign(Object.assign({ 'Content-Type': contentType }, Object.fromEntries(Object.entries(params).filter((entry) => typeof entry[1] === 'string'))), (options.auth && {
...
function readFilestream(fileStream) {
    return __awaiter(this, void 0, void 0, function* () {
