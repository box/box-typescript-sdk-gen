...
function createFetchOptions(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        fetchOptions = {
            method,
            headers: Object.assign(Object.assign(Object.assign({ 'Content-Type': contentType }, headers), (options.auth && {
...
function fetch(resource, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield (0, node_fetch_1.default)(''.concat(resource, Object.keys(params).length === 0 || resource.endsWith('?') ? '' : '?', new URLSearchParams(params).toString()), fetchOptions);
        if (!response.ok) {
      ...
      ${responseBody}`);
        ...
        return {
            ...
            content: stream_1.Readable.from(responseBytesBuffer),
        };
    });
}
exports.fetch = fetch;
