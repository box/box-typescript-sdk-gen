...
function deserializeFolderFull(val) {
    ...
    if (!(0, json_js_1.isJson)(val.is_collaboration_restricted_to_enterprise, "boolean")) {
        throw "Expecting boolean for \"is_collaboration_restricted_to_enterprise\" of type \"FolderFull\"";
    }
    const isCollaborationRestrictedToEnterprise = val.is_collaboration_restricted_to_enterprise;
    ...
    if (!(0, json_js_1.isJson)(val.allowed_shared_link_access_levels, "array")) {
        throw "Expecting array for \"allowed_shared_link_access_levels\" of type \"FolderFull\"";
    }
    const allowedSharedLinkAccessLevels = val.allowed_shared_link_access_levels.map(function (itm) {
    ...
    if (!(0, json_js_1.isJson)(val.allowed_invitee_roles, "array")) {
        throw "Expecting array for \"allowed_invitee_roles\" of type \"FolderFull\"";
    }
    const allowedInviteeRoles = val.allowed_invitee_roles.map(function (itm) {
    ...
    const watermarkInfo = deserializeFolderFullWatermarkInfoField(val.watermark_info);
...
function serializeFolderFull(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["sync_state"]: val.syncState === void 0 ? void 0 : serializeFolderFullSyncStateField(val.syncState), ["has_collaborations"]: val.hasCollaborations, ["permissions"]: serializeFolderFullPermissionsField(val.permissions), ["tags"]: val.tags.map(function (item) {
            return void 0;
...
function deserializeCollaboration(val) {
    ...
    const accessibleBy = val.accessible_by === void 0 ? void 0 : deserializeUserMini(val.accessible_by);
...
function deserializeFileFull(val) {
    ...
    const permissions = deserializeFileFullPermissionsField(val.permissions);
    if (val.tags === void 0) {
...
function serializeFileFull(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["version_number"]: val.versionNumber, ["comment_count"]: val.commentCount, ["permissions"]: serializeFileFullPermissionsField(val.permissions), ["tags"]: val.tags.map(function (item) {
            return void 0;
...
function deserializeSkillCardTypeField(val) {
    if (!(0, json_js_1.isJson)(val, "string")) {
...
exports.deserializeSkillCardTypeField = deserializeSkillCardTypeField;
function serializeSkillCardTypeField(val) {
    return val;
}
exports.serializeSkillCardTypeField = serializeSkillCardTypeField;
function deserializeSkillCardSkillCardTypeField(val) {
    if (!(0, json_js_1.isJson)(val, "string")) {
...
exports.deserializeSkillCardSkillCardTypeField = deserializeSkillCardSkillCardTypeField;
function serializeSkillCardSkillCardTypeField(val) {
    return val;
}
exports.serializeSkillCardSkillCardTypeField = serializeSkillCardSkillCardTypeField;
function deserializeSkillCardSkillCardTitleField(val) {
    if (!(0, json_js_1.isJson)(val, "object")) {
...
exports.deserializeSkillCardSkillCardTitleField = deserializeSkillCardSkillCardTitleField;
function serializeSkillCardSkillCardTitleField(val) {
    return { ["code"]: val.code, ["message"]: val.message };
}
exports.serializeSkillCardSkillCardTitleField = serializeSkillCardSkillCardTitleField;
function deserializeSkillCardStatusFieldCodeField(val) {
    if (!(0, json_js_1.isJson)(val, "string")) {
...
exports.deserializeSkillCardStatusFieldCodeField = deserializeSkillCardStatusFieldCodeField;
function serializeSkillCardStatusFieldCodeField(val) {
    return val;
}
exports.serializeSkillCardStatusFieldCodeField = serializeSkillCardStatusFieldCodeField;
function deserializeSkillCardStatusField(val) {
    if (!(0, json_js_1.isJson)(val, "object")) {
    ...
    const code = deserializeSkillCardStatusFieldCodeField(val.code);
    if (!(val.message === void 0) && !(0, json_js_1.isJson)(val.message, "string")) {
...
exports.deserializeSkillCardStatusField = deserializeSkillCardStatusField;
function serializeSkillCardStatusField(val) {
    return { ["code"]: serializeSkillCardStatusFieldCodeField(val.code), ["message"]: val.message };
}
exports.serializeSkillCardStatusField = serializeSkillCardStatusField;
function deserializeSkillCardSkillFieldTypeField(val) {
    if (!(0, json_js_1.isJson)(val, "string")) {
...
exports.deserializeSkillCardSkillFieldTypeField = deserializeSkillCardSkillFieldTypeField;
function serializeSkillCardSkillFieldTypeField(val) {
    return val;
}
exports.serializeSkillCardSkillFieldTypeField = serializeSkillCardSkillFieldTypeField;
function deserializeSkillCardSkillField(val) {
    if (!(0, json_js_1.isJson)(val, "object")) {
    ...
    const type = deserializeSkillCardSkillFieldTypeField(val.type);
    if (val.id === void 0) {
...
exports.deserializeSkillCardSkillField = deserializeSkillCardSkillField;
function serializeSkillCardSkillField(val) {
    return { ["type"]: serializeSkillCardSkillFieldTypeField(val.type), ["id"]: val.id };
}
exports.serializeSkillCardSkillField = serializeSkillCardSkillField;
function deserializeSkillCardInvocationFieldTypeField(val) {
    if (!(0, json_js_1.isJson)(val, "string")) {
...
exports.deserializeSkillCardInvocationFieldTypeField = deserializeSkillCardInvocationFieldTypeField;
function serializeSkillCardInvocationFieldTypeField(val) {
    return val;
}
exports.serializeSkillCardInvocationFieldTypeField = serializeSkillCardInvocationFieldTypeField;
function deserializeSkillCardInvocationField(val) {
    if (!(0, json_js_1.isJson)(val, "object")) {
    ...
    const type = deserializeSkillCardInvocationFieldTypeField(val.type);
    if (val.id === void 0) {
...
exports.deserializeSkillCardInvocationField = deserializeSkillCardInvocationField;
function serializeSkillCardInvocationField(val) {
    return { ["type"]: serializeSkillCardInvocationFieldTypeField(val.type), ["id"]: val.id };
}
exports.serializeSkillCardInvocationField = serializeSkillCardInvocationField;
function deserializeSkillCardEntriesFieldAppearsField(val) {
    if (!(0, json_js_1.isJson)(val, "object")) {
...
exports.deserializeSkillCardEntriesFieldAppearsField = deserializeSkillCardEntriesFieldAppearsField;
function serializeSkillCardEntriesFieldAppearsField(val) {
    return { ["start"]: val.start, ["end"]: val.end };
}
exports.serializeSkillCardEntriesFieldAppearsField = serializeSkillCardEntriesFieldAppearsField;
function deserializeSkillCardEntriesField(val) {
    if (!(0, json_js_1.isJson)(val, "object")) {
...
exports.deserializeSkillCardEntriesField = deserializeSkillCardEntriesField;
function serializeSkillCardEntriesField(val) {
...
exports.serializeSkillCardEntriesField = serializeSkillCardEntriesField;
function deserializeSkillCard(val) {
    if (!(0, json_js_1.isJson)(val, "object")) {
    ...
    const type = deserializeSkillCardTypeField(val.type);
    if (val.skill_card_type === void 0) {
        throw "Expecting \"skill_card_type\" of type \"SkillCard\" to be defined";
    }
    const skillCardType = deserializeSkillCardSkillCardTypeField(val.skill_card_type);
    const skillCardTitle = val.skill_card_title === void 0 ? void 0 : deserializeSkillCardSkillCardTitleField(val.skill_card_title);
    const status = val.status === void 0 ? void 0 : deserializeSkillCardStatusField(val.status);
    if (val.skill === void 0) {
        throw "Expecting \"skill\" of type \"SkillCard\" to be defined";
    }
    const skill = deserializeSkillCardSkillField(val.skill);
    if (val.invocation === void 0) {
        throw "Expecting \"invocation\" of type \"SkillCard\" to be defined";
    }
    const invocation = deserializeSkillCardInvocationField(val.invocation);
    ...
    return { createdAt: createdAt, type: type, skillCardType: skillCardType, skillCardTitle: skillCardTitle, status: status, skill: skill, invocation: invocation, duration: duration, entries: entries };
}
exports.deserializeSkillCard = deserializeSkillCard;
function serializeSkillCard(val) {
    return { ["created_at"]: val.createdAt, ["type"]: serializeSkillCardTypeField(val.type), ["skill_card_type"]: serializeSkillCardSkillCardTypeField(val.skillCardType), ["skill_card_title"]: val.skillCardTitle === void 0 ? void 0 : serializeSkillCardSkillCardTitleField(val.skillCardTitle), ["status"]: val.status === void 0 ? void 0 : serializeSkillCardStatusField(val.status), ["skill"]: serializeSkillCardSkillField(val.skill), ["invocation"]: serializeSkillCardInvocationField(val.invocation), ["duration"]: val.duration, ["entries"]: val.entries === void 0 ? void 0 : val.entries.map(function (item) {
            return serializeSkillCardEntriesField(item);
        }) };
}
exports.serializeSkillCard = serializeSkillCard;
