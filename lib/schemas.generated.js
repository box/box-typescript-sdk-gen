...
function deserializeShieldInformationBarrierSegmentMember(val) {
    ...
    const id = (0, json_js_1.isJson)(val.id, "string") ? val.id : void 0;
    const type = val.type == void 0 ? void 0 : deserializeShieldInformationBarrierSegmentMemberBaseTypeField(val.type);
    return { shieldInformationBarrier: shieldInformationBarrier, shieldInformationBarrierSegment: shieldInformationBarrierSegment, createdAt: createdAt, createdBy: createdBy, updatedAt: updatedAt, updatedBy: updatedBy, user: user, id: id, type: type };
}
...
function serializeSearchResultsWithSharedLinks(val) {
    return { ["total_count"]: val.totalCount, ["limit"]: val.limit, ["offset"]: val.offset, ["type"]: val.type == void 0 ? void 0 : serializeSearchResultsWithSharedLinksTypeField(val.type), ["entries"]: val.entries == void 0 ? void 0 : val.entries.map(function (item) {
...
function deserializeSearchResultsWithSharedLinks(val) {
    ...
    const limit = (0, json_js_1.isJson)(val.limit, "number") ? val.limit : void 0;
    const offset = (0, json_js_1.isJson)(val.offset, "number") ? val.offset : void 0;
    const type = val.type == void 0 ? void 0 : deserializeSearchResultsWithSharedLinksTypeField(val.type);
    const entries = (0, json_js_1.isJson)(val.entries, "array") ? val.entries.map(function (itm) {
        return deserializeSearchResultWithSharedLink(itm);
    }) : void 0;
    return { totalCount: totalCount, limit: limit, offset: offset, type: type, entries: entries };
}
...
function serializeSearchResults(val) {
    return { ["total_count"]: val.totalCount, ["limit"]: val.limit, ["offset"]: val.offset, ["type"]: val.type == void 0 ? void 0 : serializeSearchResultsTypeField(val.type), ["entries"]: val.entries == void 0 ? void 0 : val.entries.map(function (item) {
