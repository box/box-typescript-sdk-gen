...
const task_generated_js_1 = require("./task.generated.js");
const task_generated_js_2 = require("./task.generated.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, task_generated_js_1.serializeTask)(item);
            }),
    };
}
function deserializeTasks(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: 'Expecting a map for "Tasks"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_2.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, task_generated_js_2.deserializeTask)(itm);
            })
            : [];
