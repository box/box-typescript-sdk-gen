...
exports.serializeShieldInformationBarriers = serializeShieldInformationBarriers;
exports.deserializeShieldInformationBarriers = deserializeShieldInformationBarriers;
const shieldInformationBarrier_generated_js_1 = require("./shieldInformationBarrier.generated.js");
const shieldInformationBarrier_generated_js_2 = require("./shieldInformationBarrier.generated.js");
const errors_js_1 = require("../box/errors.js");
const json_js_1 = require("../serialization/json.js");
const json_js_2 = require("../serialization/json.js");
const json_js_3 = require("../serialization/json.js");
const json_js_4 = require("../serialization/json.js");
function serializeShieldInformationBarriers(val) {
    return {
        ['limit']: val.limit,
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, shieldInformationBarrier_generated_js_1.serializeShieldInformationBarrier)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, shieldInformationBarrier_generated_js_2.deserializeShieldInformationBarrier)(itm);
            })
            : [];
    return {
        limit: limit,
