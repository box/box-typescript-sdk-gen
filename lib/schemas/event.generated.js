...
const appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser_generated_js_1 = require("./appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser.generated.js");
const appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser_generated_js_2 = require("./appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser.generated.js");
...
function deserializeEventEventTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize EventEventTypeField" });
}
...
function serializeEvent(val) {
    return {
        ...
        ['recorded_at']: val.recordedAt == void 0
            ? val.recordedAt
            : (0, utils_js_1.serializeDateTime)(val.recordedAt),
        ...
        ['source']: val.source == void 0
            ? val.source
            : (0, appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser_generated_js_1.serializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser)(val.source),
...
function deserializeEvent(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: 'Expecting a map for "Event"' });
    }
    ...
    if (!(val.recorded_at == void 0) && !(0, json_js_1.sdIsString)(val.recorded_at)) {
        throw new errors_js_1.BoxSdkError({
            message: 'Expecting string for "recorded_at" of type "Event"',
        });
    }
    const recordedAt = val.recorded_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.recorded_at);
    if (!(val.event_id == void 0) && !(0, json_js_1.sdIsString)(val.event_id)) {
        throw new errors_js_1.BoxSdkError({
    ...
    if (!(val.session_id == void 0) && !(0, json_js_1.sdIsString)(val.session_id)) {
        throw new errors_js_1.BoxSdkError({
    ...
    const source = val.source == void 0
        ? void 0
        : (0, appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser_generated_js_2.deserializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser)(val.source);
