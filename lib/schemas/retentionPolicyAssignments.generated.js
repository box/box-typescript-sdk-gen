...
const retentionPolicyAssignment_generated_js_1 = require("./retentionPolicyAssignment.generated.js");
const retentionPolicyAssignment_generated_js_2 = require("./retentionPolicyAssignment.generated.js");
    ...
    return {
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, retentionPolicyAssignment_generated_js_1.serializeRetentionPolicyAssignment)(item);
            }),
        ['limit']: val.limit,
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, retentionPolicyAssignment_generated_js_2.deserializeRetentionPolicyAssignment)(itm);
            })
            : [];
