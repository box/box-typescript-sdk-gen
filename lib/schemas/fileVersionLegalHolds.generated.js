...
const fileVersionLegalHold_generated_js_1 = require("./fileVersionLegalHold.generated.js");
const fileVersionLegalHold_generated_js_2 = require("./fileVersionLegalHold.generated.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, fileVersionLegalHold_generated_js_1.serializeFileVersionLegalHold)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, fileVersionLegalHold_generated_js_2.deserializeFileVersionLegalHold)(itm);
            })
            : [];
    return {
        limit: limit,
