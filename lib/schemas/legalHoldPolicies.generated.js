...
const legalHoldPolicy_generated_js_1 = require("./legalHoldPolicy.generated.js");
const legalHoldPolicy_generated_js_2 = require("./legalHoldPolicy.generated.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, legalHoldPolicy_generated_js_1.serializeLegalHoldPolicy)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, legalHoldPolicy_generated_js_2.deserializeLegalHoldPolicy)(itm);
            })
            : [];
    return {
        limit: limit,
