...
const collaborationAllowlistEntry_generated_js_1 = require("./collaborationAllowlistEntry.generated.js");
const collaborationAllowlistEntry_generated_js_2 = require("./collaborationAllowlistEntry.generated.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, collaborationAllowlistEntry_generated_js_1.serializeCollaborationAllowlistEntry)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, collaborationAllowlistEntry_generated_js_2.deserializeCollaborationAllowlistEntry)(itm);
            })
            : [];
    return {
        limit: limit,
