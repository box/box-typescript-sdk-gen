...
const metadataTemplate_generated_js_1 = require("./metadataTemplate.generated.js");
const metadataTemplate_generated_js_2 = require("./metadataTemplate.generated.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, metadataTemplate_generated_js_1.serializeMetadataTemplate)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, metadataTemplate_generated_js_2.deserializeMetadataTemplate)(itm);
            })
            : [];
    return {
        limit: limit,
