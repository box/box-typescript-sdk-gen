...
exports.serializeDocGenTagsV2025R0 = serializeDocGenTagsV2025R0;
exports.deserializeDocGenTagsV2025R0 = deserializeDocGenTagsV2025R0;
const docGenTagV2025R0_generated_js_1 = require("./docGenTagV2025R0.generated.js");
const docGenTagV2025R0_generated_js_2 = require("./docGenTagV2025R0.generated.js");
const errors_js_1 = require("../../box/errors.js");
const json_js_1 = require("../../serialization/json.js");
const json_js_2 = require("../../serialization/json.js");
const json_js_3 = require("../../serialization/json.js");
const json_js_4 = require("../../serialization/json.js");
function serializeDocGenTagsV2025R0(val) {
    return {
        ['limit']: val.limit,
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, docGenTagV2025R0_generated_js_1.serializeDocGenTagV2025R0)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, docGenTagV2025R0_generated_js_2.deserializeDocGenTagV2025R0)(itm);
            })
            : [];
    return {
        limit: limit,
