    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, webhookMini_generated_js_1.serializeWebhookMini)(item);
            }),
    };
}
function deserializeWebhooks(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: 'Expecting a map for "Webhooks"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, webhookMini_generated_js_2.deserializeWebhookMini)(itm);
            })
            : [];
    return {
        limit: limit,
