...
const storagePolicyAssignment_generated_js_1 = require("./storagePolicyAssignment.generated.js");
const storagePolicyAssignment_generated_js_2 = require("./storagePolicyAssignment.generated.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, storagePolicyAssignment_generated_js_1.serializeStoragePolicyAssignment)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, storagePolicyAssignment_generated_js_2.deserializeStoragePolicyAssignment)(itm);
            })
            : [];
    return {
        limit: limit,
