...
exports.serializeAppItemAssociations = serializeAppItemAssociations;
exports.deserializeAppItemAssociations = deserializeAppItemAssociations;
const appItemAssociation_generated_js_1 = require("./appItemAssociation.generated.js");
const appItemAssociation_generated_js_2 = require("./appItemAssociation.generated.js");
const errors_js_1 = require("../box/errors.js");
const json_js_1 = require("../serialization/json.js");
const json_js_2 = require("../serialization/json.js");
const json_js_3 = require("../serialization/json.js");
const json_js_4 = require("../serialization/json.js");
function serializeAppItemAssociations(val) {
    return {
        ['limit']: val.limit,
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, appItemAssociation_generated_js_1.serializeAppItemAssociation)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_js_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, appItemAssociation_generated_js_2.deserializeAppItemAssociation)(itm);
            })
            : [];
    return {
        limit: limit,
