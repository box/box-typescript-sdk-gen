...
export type UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField = "replace";
export type UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField = "/Box__Security__Classification__Key";
...
export class UpdateFileMetadataEnterpriseSecurityClassificationHeadersArg {
    ...
    constructor(fields: UpdateFileMetadataEnterpriseSecurityClassificationHeadersArg) {
        Object.assign(this, fields);
    }
}
...
export class FileClassificationsManager {
    ...
    constructor(fields: Omit<FileClassificationsManager, "getFileMetadataEnterpriseSecurityClassification6VmVochwUWo" | "createFileMetadataEnterpriseSecurityClassification" | "updateFileMetadataEnterpriseSecurityClassification" | "deleteFileMetadataEnterpriseSecurityClassification">) {
        Object.assign(this, fields);
    }
    ...
    async updateFileMetadataEnterpriseSecurityClassification(fileId: string, requestBody: readonly UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArg[], headers: UpdateFileMetadataEnterpriseSecurityClassificationHeadersArg = new UpdateFileMetadataEnterpriseSecurityClassificationHeadersArg({})): Promise<Classification> {
        ...
        const response: FetchResponse = await fetch("".concat("https://api.box.com/2.0/files/", fileId, "/metadata/enterprise/securityClassification-6VMVochwUWo") as string, { method: "PUT", headers: headersMap, body: serializeJson(requestBody.map(serializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArg) as readonly any[]), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession } satisfies FetchOptions) as FetchResponse;
        return deserializeClassification(deserializeJson(response.text));
    }
...
export function serializeCreateFileMetadataEnterpriseSecurityClassificationRequestBodyArg(val: CreateFileMetadataEnterpriseSecurityClassificationRequestBodyArg): Json {
    return { ["Box__Security__Classification__Key"]: val.boxSecurityClassificationKey == void 0 ? void 0 : val.boxSecurityClassificationKey };
}
...
export function serializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField(val: UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField): Json {
    return val;
}
export function deserializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField(val: any): UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField {
...
export function serializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField(val: UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField): Json {
    return val;
}
export function deserializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField(val: any): UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField {
    if (!isJson(val, "string")) {
...
export function serializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArg(val: UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArg): Json {
    return { ["op"]: val.op == void 0 ? void 0 : serializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField(val.op), ["path"]: val.path == void 0 ? void 0 : serializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField(val.path), ["value"]: val.value == void 0 ? void 0 : val.value };
}
export function deserializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArg(val: any): UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArg {
    const op: undefined | UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField = val.op == void 0 ? void 0 : deserializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgOpField(val.op);
    const path: undefined | UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField = val.path == void 0 ? void 0 : deserializeUpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArgPathField(val.path);
    const value: undefined | string = val.value == void 0 ? void 0 : val.value;
    return { op: op, path: path, value: value } satisfies UpdateFileMetadataEnterpriseSecurityClassificationRequestBodyArg;
}
