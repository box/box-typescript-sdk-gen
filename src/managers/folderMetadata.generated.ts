...
export type UpdateFolderMetadataByIdRequestBodyArgOpField = "add" | "replace" | "remove" | "test" | "move" | "copy";
...
export class FolderMetadataManager {
    ...
    constructor(fields: Omit<FolderMetadataManager, "getFolderMetadata" | "getFolderMetadataById" | "createFolderMetadataById" | "updateFolderMetadataById" | "deleteFolderMetadataById">) {
        Object.assign(this, fields);
    }
    ...
    async updateFolderMetadataById(folderId: string, scope: UpdateFolderMetadataByIdScopeArg, templateKey: string, requestBody: readonly UpdateFolderMetadataByIdRequestBodyArg[], headers: UpdateFolderMetadataByIdHeadersArg = new UpdateFolderMetadataByIdHeadersArg({})): Promise<Metadata> {
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
...
export function serializeUpdateFolderMetadataByIdScopeArg(val: UpdateFolderMetadataByIdScopeArg): Json {
    return val;
}
export function deserializeUpdateFolderMetadataByIdScopeArg(val: any): UpdateFolderMetadataByIdScopeArg {
    if (!isJson(val, "string")) {
...
export function serializeUpdateFolderMetadataByIdRequestBodyArgOpField(val: UpdateFolderMetadataByIdRequestBodyArgOpField): Json {
    return val;
}
export function deserializeUpdateFolderMetadataByIdRequestBodyArgOpField(val: any): UpdateFolderMetadataByIdRequestBodyArgOpField {
    if (!isJson(val, "string")) {
...
export function serializeUpdateFolderMetadataByIdRequestBodyArg(val: UpdateFolderMetadataByIdRequestBodyArg): Json {
    return { ["op"]: val.op == void 0 ? void 0 : serializeUpdateFolderMetadataByIdRequestBodyArgOpField(val.op), ["path"]: val.path == void 0 ? void 0 : val.path, ["value"]: val.value == void 0 ? void 0 : val.value, ["from"]: val.from == void 0 ? void 0 : val.from };
}
export function deserializeUpdateFolderMetadataByIdRequestBodyArg(val: any): UpdateFolderMetadataByIdRequestBodyArg {
    const op: undefined | UpdateFolderMetadataByIdRequestBodyArgOpField = val.op == void 0 ? void 0 : deserializeUpdateFolderMetadataByIdRequestBodyArgOpField(val.op);
    ...
    return { op: op, path: path, value: value, from: from } satisfies UpdateFolderMetadataByIdRequestBodyArg;
}
