import { newSerializeUsers } from "../schemas.generated.js";
import { newDeserializeUsers } from "../schemas.generated.js";
import { newSerializeClientError } from "../schemas.generated.js";
import { newDeserializeClientError } from "../schemas.generated.js";
import { newSerializeUser } from "../schemas.generated.js";
import { newDeserializeUser } from "../schemas.generated.js";
import { newSerializeTrackingCode } from "../schemas.generated.js";
import { newDeserializeTrackingCode } from "../schemas.generated.js";
...
export class UsersManager {
    ...
    async getUsers(queryParams: undefined | GetUsersQueryParamsArg = {} satisfies GetUsersQueryParamsArg): Promise<Users> {
        ...
        return newDeserializeUsers(deserializeJson(response.text));
    }
    async createUser(requestBody: CreateUserRequestBodyArg, queryParams: undefined | CreateUserQueryParamsArg = {} satisfies CreateUserQueryParamsArg): Promise<User> {
        ...
        return newDeserializeUser(deserializeJson(response.text));
    }
    async getUserMe(queryParams: undefined | GetUserMeQueryParamsArg = {} satisfies GetUserMeQueryParamsArg): Promise<UserFull> {
        ...
        return newDeserializeUserFull(deserializeJson(response.text));
    }
...
export function newSerializeGetUsersQueryParamsArgUserTypeField(val: GetUsersQueryParamsArgUserTypeField): Json {
    return val;
}
export function newDeserializeGetUsersQueryParamsArgUserTypeField(val: any): GetUsersQueryParamsArgUserTypeField {
...
export function newSerializeGetUsersQueryParamsArg(val: GetUsersQueryParamsArg): Json {
...
export function newDeserializeGetUsersQueryParamsArg(val: any): GetUsersQueryParamsArg {
    const filterTerm: undefined | string = isJson(val.filterTerm, "string") ? val.filterTerm : void 0;
    const userType: undefined | GetUsersQueryParamsArgUserTypeField = val.userType == void 0 ? void 0 : newDeserializeGetUsersQueryParamsArgUserTypeField(val.userType);
...
export function newSerializeCreateUserRequestBodyArgRoleField(val: CreateUserRequestBodyArgRoleField): Json {
    return val;
}
export function newDeserializeCreateUserRequestBodyArgRoleField(val: any): CreateUserRequestBodyArgRoleField {
    if (!isJson(val, "string")) {
...
export function newSerializeCreateUserRequestBodyArgStatusField(val: CreateUserRequestBodyArgStatusField): Json {
    return val;
}
export function newDeserializeCreateUserRequestBodyArgStatusField(val: any): CreateUserRequestBodyArgStatusField {
    if (!isJson(val, "string")) {
...
export function newSerializeCreateUserRequestBodyArg(val: CreateUserRequestBodyArg): Json {
    return { ["name"]: val.name, ["login"]: val.login, ["isPlatformAccessOnly"]: val.isPlatformAccessOnly, ["role"]: val.role == void 0 ? void 0 : newSerializeCreateUserRequestBodyArgRoleField(val.role), ["language"]: val.language, ["isSyncEnabled"]: val.isSyncEnabled, ["jobTitle"]: val.jobTitle, ["phone"]: val.phone, ["address"]: val.address, ["spaceAmount"]: val.spaceAmount, ["trackingCodes"]: val.trackingCodes == void 0 ? void 0 : val.trackingCodes.map(function (item: TrackingCode): any {
...
export function newDeserializeCreateUserRequestBodyArg(val: any): CreateUserRequestBodyArg {
    ...
    const role: undefined | CreateUserRequestBodyArgRoleField = val.role == void 0 ? void 0 : newDeserializeCreateUserRequestBodyArgRoleField(val.role);
    ...
    const status: undefined | CreateUserRequestBodyArgStatusField = val.status == void 0 ? void 0 : newDeserializeCreateUserRequestBodyArgStatusField(val.status);
    const externalAppUserId: undefined | string = isJson(val.externalAppUserId, "string") ? val.externalAppUserId : void 0;
...
export function newSerializeCreateUserQueryParamsArg(val: CreateUserQueryParamsArg): Json {
    return { ["fields"]: val.fields };
}
export function newDeserializeCreateUserQueryParamsArg(val: any): CreateUserQueryParamsArg {
    const fields: undefined | string = isJson(val.fields, "string") ? val.fields : void 0;
    return { fields: fields } satisfies CreateUserQueryParamsArg;
}
export function newSerializeGetUserMeQueryParamsArg(val: GetUserMeQueryParamsArg): Json {
    return { ["fields"]: val.fields };
}
export function newDeserializeGetUserMeQueryParamsArg(val: any): GetUserMeQueryParamsArg {
    const fields: undefined | string = isJson(val.fields, "string") ? val.fields : void 0;
    return { fields: fields } satisfies GetUserMeQueryParamsArg;
}
export function newSerializeGetUserByIdQueryParamsArg(val: GetUserByIdQueryParamsArg): Json {
    return { ["fields"]: val.fields };
}
export function newDeserializeGetUserByIdQueryParamsArg(val: any): GetUserByIdQueryParamsArg {
    const fields: undefined | string = isJson(val.fields, "string") ? val.fields : void 0;
    return { fields: fields } satisfies GetUserByIdQueryParamsArg;
}
export function newSerializeUpdateUserByIdRequestBodyArgRoleField(val: UpdateUserByIdRequestBodyArgRoleField): Json {
    return val;
}
export function newDeserializeUpdateUserByIdRequestBodyArgRoleField(val: any): UpdateUserByIdRequestBodyArgRoleField {
    if (!isJson(val, "string")) {
...
export function newSerializeUpdateUserByIdRequestBodyArgStatusField(val: UpdateUserByIdRequestBodyArgStatusField): Json {
    return val;
}
export function newDeserializeUpdateUserByIdRequestBodyArgStatusField(val: any): UpdateUserByIdRequestBodyArgStatusField {
    if (!isJson(val, "string")) {
...
export function newSerializeUpdateUserByIdRequestBodyArgNotificationEmailField(val: UpdateUserByIdRequestBodyArgNotificationEmailField): Json {
    return { ["email"]: val.email };
}
export function newDeserializeUpdateUserByIdRequestBodyArgNotificationEmailField(val: any): UpdateUserByIdRequestBodyArgNotificationEmailField {
...
export function newSerializeUpdateUserByIdRequestBodyArg(val: UpdateUserByIdRequestBodyArg): Json {
...
export function newDeserializeUpdateUserByIdRequestBodyArg(val: any): UpdateUserByIdRequestBodyArg {
    ...
    const login: undefined | string = isJson(val.login, "string") ? val.login : void 0;
    const role: undefined | UpdateUserByIdRequestBodyArgRoleField = val.role == void 0 ? void 0 : newDeserializeUpdateUserByIdRequestBodyArgRoleField(val.role);
    const language: undefined | string = isJson(val.language, "string") ? val.language : void 0;
    const isSyncEnabled: undefined | boolean = isJson(val.isSyncEnabled, "boolean") ? val.isSyncEnabled : void 0;
    const jobTitle: undefined | string = isJson(val.jobTitle, "string") ? val.jobTitle : void 0;
    const phone: undefined | string = isJson(val.phone, "string") ? val.phone : void 0;
    ...
    const status: undefined | UpdateUserByIdRequestBodyArgStatusField = val.status == void 0 ? void 0 : newDeserializeUpdateUserByIdRequestBodyArgStatusField(val.status);
    const spaceAmount: undefined | number = isJson(val.spaceAmount, "number") ? val.spaceAmount : void 0;
    const notificationEmail: undefined | UpdateUserByIdRequestBodyArgNotificationEmailField = val.notificationEmail == void 0 ? void 0 : newDeserializeUpdateUserByIdRequestBodyArgNotificationEmailField(val.notificationEmail);
    const externalAppUserId: undefined | string = isJson(val.externalAppUserId, "string") ? val.externalAppUserId : void 0;
...
export function newSerializeUpdateUserByIdQueryParamsArg(val: UpdateUserByIdQueryParamsArg): Json {
    return { ["fields"]: val.fields };
}
export function newDeserializeUpdateUserByIdQueryParamsArg(val: any): UpdateUserByIdQueryParamsArg {
    const fields: undefined | string = isJson(val.fields, "string") ? val.fields : void 0;
    return { fields: fields } satisfies UpdateUserByIdQueryParamsArg;
}
export function newSerializeDeleteUserByIdQueryParamsArg(val: DeleteUserByIdQueryParamsArg): Json {
    return { ["notify"]: val.notify, ["force"]: val.force };
}
export function newDeserializeDeleteUserByIdQueryParamsArg(val: any): DeleteUserByIdQueryParamsArg {
    const notify: undefined | boolean = isJson(val.notify, "boolean") ? val.notify : void 0;
